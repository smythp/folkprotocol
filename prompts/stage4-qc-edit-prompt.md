...
Check for academic jargon that needs simplification:

**Statistical language:**
```
[ ] "RCT" without "clinical trial" explanation?
[ ] "MD/SMD" with CI ranges but no plain language translation?
[ ] "I²=0%" instead of "consistent results"?
[ ] "n=899" without "participants" on first use?
[ ] "Preclinical" instead of "animal studies"?
```

**Medical terminology:**
```
[ ] Undefined jargon (mineralocorticoid, laryngopharyngeal, etc.)?
[ ] Latin anatomy without common names (mucous membranes → throat lining)?
[ ] Unexplained acronyms (EMA, HMPC without spelling out first time)?
[ ] Complex mechanisms without inline definitions?
[ ] "Contraindicated in [condition]" instead of "not recommended for people with"?
```

**Action:** Simplify to 8th-grade reading level while keeping all numbers and citations

**Good transformations:**
- "RCT (n=899)" → "clinical trial with 899 participants"
- "MD -1.05, 95% CI -1.48 to -0.62" → "reduced by about one episode per day [1]"
- "Preclinical studies found" → "Animal studies found"
- "Mucous membranes" → "throat lining" or "throat and airways"
- "Contraindicated in hypertension" → "Not recommended for people with high blood pressure"
