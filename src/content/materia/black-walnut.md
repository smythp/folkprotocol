...
traditional:
  ...
  convergent: false
  attributions:
    - source: "North American Indigenous (pre-contact through 19th century)"
      text: "Unripe green hull preparations for intestinal worm expulsion. Fresh hull juice applied topically to ringworm, eczema, and skin parasites. Bark decoctions for wound antiseptic and mouth sores. Hull teas as purgatives."
    - source: "Eclectic Physicians (United States, ~1820s–1930s)"
      text: "Primary anthelmintic use adopted from Indigenous practice. Topical application for herpetic eruptions, eczema, impetigo, favus, and ringworm. Used as an 'alterative' for syphilis and scrofula in pre-antibiotic practice. Often combined with yellow dock and sarsaparilla."
    - source: "North American folk herbalism (20th century–present)"
      text: "Hull tincture for Candida overgrowth and parasite cleanse protocols — commonly combined with wormwood and cloves. Topical tincture for athlete's foot and nail fungus remains widespread."

evidence:
  summary: "No human RCTs exist for any therapeutic indication — an unusual position even by herbal standards. The only regulatory recognition worldwide is Health Canada's 2022 traditional-use vermifuge claim, which required no clinical trial data. All mechanistic evidence is in vitro or animal-model only. Juglone demonstrates antimicrobial, antifungal, and cytotoxic activity in cell models. Anti-inflammatory activity in human U-937 cells is cultivar-dependent (Ho 2019). Rat pharmacokinetics show ~40–50% oral absorption with a short 2-hour half-life and renal covalent accumulation. Juglone's Ames-positive mutagenicity (Erisen 2020) constrains internal use to defined short courses."
  keyStudies:
    - title: "Health Canada NHPID Traditional Use Monograph"
      finding: "Traditional vermifuge/anthelmintic use approved for adults 18+; dose 0.65–2.75 g/day unripe hull; occasional use; consult practitioner beyond 14 days. The only official regulatory monograph for Juglans nigra anywhere in the world."
      year: 2022
    - title: "Erisen et al. — Juglone Cytotoxicity and Mutagenicity"
      finding: "Free juglone Ames-positive (Salmonella TA98 with S9 metabolic activation) at 1.25–2.5 μmol/L; IC50 in mouse fibroblasts 60 μmol/L at 48h; nano-encapsulated juglone eliminated mutagenicity in the same assay — but no commercial preparation uses nanoencapsulation"
      year: 2020
    - title: "Ho et al. — Anti-inflammatory Activity in Human U-937 Cells"
      finding: "Kernel extracts from 'Surprise' and 'Sparrow' cultivars inhibited all 6 detected proinflammatory cytokines/chemokines in LPS-stimulated human U-937 promonocytic cells; 'Daniel', 'Mystry', and 'Sparks' cultivars showed weak or no effect — anti-inflammatory activity is strongly cultivar-dependent, not a universal species property"
      year: 2019
    - title: "Osztie et al. — Phytochemical Profile and PAMPA Bioavailability"
      finding: "161 compounds identified across hull, bark, and leaf by UHPLC-HR-MS/MS; juglone shows positive GI epithelial and blood-brain-barrier permeability via PAMPA passive diffusion — first published bioavailability data for any Juglans nigra compound"
      year: 2024
    - title: "Chen et al. — Juglone Pharmacokinetics in Male F344 Rats"
      finding: "Oral bioavailability ~40–50% within 24h; primary metabolism via glucuronidation and reduction; juglone accumulates preferentially in kidney via covalent binding to renal cytosolic proteins; dermal absorption <20% — only available in vivo PK dataset for juglone"
      year: 2006
    - title: "Aithal et al. — Free vs. Liposomal Juglone PK"
      finding: "Free juglone plasma half-life ~2 hours; liposomal encapsulation provides 12-fold improvement in half-life; commercial preparations contain free juglone with this poor systemic PK profile"
      year: 2011

preparations:
  - method: tincture
    dosing: "1:4 at 25% ethanol: 5–10 drops (0.25–0.5 mL) 3× daily | 1:2 liquid extract: 1.5–5.5 mL/day"
    notes: "Standard preparation for internal use. Cycle: 2 weeks on, 2 weeks off. Ethanolic extraction preserves juglone better than aqueous preparations — juglone degrades in acidic gastric conditions in water-based forms. Use unripe (green) hull; blackened hull has lower juglone content."
  - method: capsule
    dosing: "0.65–2.75 g/day dried hull powder (Health Canada NHPID approved dose)"
    notes: "250–500 mg capsules typical; 2–5 per day. Most accessible and regulatory-compliant form. Labels will not specify juglone content — Health Canada permits non-standardized extracts only; juglone instability and mutagenicity make standardization impractical."
  - method: topical
    dosing: "Undiluted tincture applied directly to affected skin area as needed"
    notes: "Traditional for athlete's foot, ringworm, and nail fungus. Juglone stains skin brown-black — warn before use. Contact sensitization risk with repeated application; test small area first. Nitrile gloves required when handling fresh hull (juglone penetrates latex)."

trying:
  duration: "Short-term only. Health Canada and all traditional sources agree: 14 days maximum for self-directed use. Traditional cycling: 2 weeks on, 2 weeks off if longer course is needed with practitioner oversight. Not appropriate for continuous daily supplementation."
  whatToNotice:
    - Resolution of presenting symptoms — parasite expulsion, fungal clearing, skin improvement
    - GI tolerance — nausea, cramping, or watery diarrhea indicate dose is too high
    - Urine and stool darkening from juglone pigment (expected, not a safety concern)
    - Contact dermatitis with topical use — stop if rash develops
    - Any sign of allergic reaction (hives, throat tightness, swelling) — stop immediately
  notes: "Start at the low end: 0.65 g/day capsule (one 500 mg tablet) or 5 drops of tincture once daily. Always take with food. Maintain a 1–2 hour gap from any other oral medications. Hard stop at 14 days regardless of outcome — if the problem didn't improve, more days won't help; clinical diagnosis and treatment is appropriate."
...
combinedWith:
  - herb: "wormwood"
    why: "Traditional parasite cleanse combination (popularized by Hulda Clark's 1990s protocols). Both have traditional anthelmintic use. No clinical data for the combination. Short-term only."
  - herb: "cloves"
    why: "Third element of the classic folk parasite cleanse triad alongside black walnut and wormwood. No clinical validation for any combination approach."
  - herb: "goldenseal"
    why: "Berberine-containing herb with documented antimicrobial and antifungal activity in vitro. Sometimes combined with black walnut in folk herbalism for gut and Candida protocols."

sources:
  - title: "Health Canada NHPID — Juglans nigra Monograph"
    link: "https://webprod.hc-sc.gc.ca/nhpid-bdipsn/atReq?atid=juglans.nigra&lang=eng"
    type: other
    year: 2022
  - title: "Erisen et al. — Cytotoxic and Mutagenic Potential of Juglone (PMID 32597139)"
    link: "https://pubmed.ncbi.nlm.nih.gov/32597139/"
    type: study
    year: 2020
  - title: "Ho et al. — Black Walnut Extracts Inhibit Proinflammatory Cytokines from U-937 (PMID 31607915)"
    link: "https://pubmed.ncbi.nlm.nih.gov/31607915/"
    type: study
    year: 2019
  - title: "Osztie et al. — Phytochemical Composition and Bioactivity of Juglans nigra (PMID 39000038)"
    link: "https://pubmed.ncbi.nlm.nih.gov/39000038/"
    type: study
    year: 2024
  - title: "Dos Santos Moreira et al. — Juglone: A Versatile Natural Platform (PMID 34348624)"
    link: "https://pubmed.ncbi.nlm.nih.gov/34348624/"
    type: study
    year: 2021
  - title: "Karki et al. — Cytotoxicity of Juglone Against Pancreatic Cancer Cells (PMID 32610056)"
    link: "https://pubmed.ncbi.nlm.nih.gov/32610056/"
    type: study
    year: 2020
  - title: "Chen et al. — Metabolism and Disposition of Juglone in Male F344 Rats (PMID 16393859)"
    link: "https://pubmed.ncbi.nlm.nih.gov/16393859/"
    type: study
    year: 2006
  - title: "Aithal et al. — Pharmacokinetics of Free and Liposomal Juglone (PMID 21523783)"
    link: "https://pubmed.ncbi.nlm.nih.gov/21523783/"
    type: study
    year: 2011
  - title: "Zhang et al. — Purification and Characterization of Jug n 4 Allergen (PMID 27936684)"
    link: "https://pubmed.ncbi.nlm.nih.gov/27936684/"
    type: study
    year: 2017
  - title: "Costa et al. — Walnut Allergens: Molecular Characterization (PMID 24382327)"
    link: "https://pubmed.ncbi.nlm.nih.gov/24382327/"
    type: study
    year: 2014
...
The anthelmintic use is the most consistent thread across sources. Unripe green hulls were prepared as teas or infusions to expel roundworms, tapeworms, and pinworms. The timing — harvesting green hulls in early autumn — aligned with the traditional "wormy season." Fresh hull juice was applied topically for ringworm and skin parasites; bark decoctions served as antiseptic gargles for mouth sores and gum disease.

**Eclectic physicians (1820s–1930s):**

The 19th-century American Eclectic school systematized Indigenous practice. Black walnut hull appeared in their materia medica for intestinal worms, skin eruptions (impetigo, herpetic, favus, ringworm), and as an "alterative" — a pre-antibiotic category for herbs thought to gradually improve metabolic function — applied to syphilis and scrofula. Their preparation: green hull extract in dilute alcohol, often alongside yellow dock and sarsaparilla.
...
Everything centers on the **unripe green hull** (pericarp). The nut meat, leaves, and bark have different phytochemical profiles and distinct applications. Green (unripe) hulls contain significantly more juglone than blackened, ripened hulls — oxidation during ripening degrades the active compound.

### Forms and Dosing

**Capsule or dried hull powder (most accessible, regulatory-compliant):**

- Health Canada approved dose: **0.65–2.75 g/day** [1]
- At 500 mg capsules: 2–5 per day
- Take with food — never on an empty stomach
- 14 days maximum, then stop
...
- 5–10 drops (0.25–0.5 mL) three times daily
- Lower hull equivalent per dose — the cautious end of the range
- Traditional cycling: 2 weeks on, 2 weeks off
...
- Ethanolic extract over aqueous preparations
- Nitrogen-purged or refrigerated storage indicated for tinctures and liquid extracts
- Third-party testing for heavy metals and microbial contamination at minimum
- GMP-certified manufacturer

**Avoid:**
- Products that don't specify hull ripeness at time of harvest
- Any product claiming standardized juglone content — this is technically dubious given juglone's instability
- Aqueous infusions marketed for internal anthelmintic use — juglone bioavailability from water-based preparations is substantially lower than from ethanolic extracts
