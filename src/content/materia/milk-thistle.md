...
traditional:
  ...
  attributions:
    - source: "German Commission E"
      text: "Approved for dyspeptic complaints, toxic liver damage, supportive treatment in chronic inflammatory liver diseases, and liver cirrhosis. Retains traditional indication for Amanita phalloides (death cap mushroom) poisoning."
    - source: "ESCOP Monograph (2009)"
      text: "Endorsed for treatment of toxic liver damage, supportive treatment in chronic inflammatory liver conditions, and hepatic conditions generally."
    - source: "European Pharmacopoeia (Monograph 1860)"
      text: "Official recognition with standardized quality specifications for refined extract: 30–65% total silymarin, defined ratios for silybin A+B (40–65%), silychristin+silydianin (20–45%), and isosilybins (10–20%)."

evidence:
  summary: "Milk thistle has stronger clinical evidence than most herbal liver remedies. Cirrhosis survival data is particularly compelling. Meta-analyses consistently show liver enzyme improvements across diverse populations and conditions. Major negative finding: does not work for chronic hepatitis C at any dose tested."
  keyStudies:
    - title: "Ferenci et al. - Silymarin in Liver Cirrhosis"
      finding: "170 patients, mean 41 months. 4-year survival 58% vs 39% placebo (p=0.036). Most effective for alcoholic cirrhosis (p=0.01) and Child A severity (p=0.03). No adverse effects over the study period."
      year: 1989
    - title: "Li et al. - Silymarin for NAFLD Meta-Analysis"
      finding: "26 RCTs, 2,375 patients. ALT decreased 12.39 units, AST 10.97 units. Total cholesterol SMD -0.85, LDL SMD -0.81, HDL increased SMD 0.46. Hepatic steatosis significantly improved (OR 3.25)."
      year: 2024
    - title: "Chan Wah Kheong et al. - NASH Anti-Fibrotic RCT"
      finding: "99 patients, 48 weeks, 2100 mg/day. Histologic fibrosis reduction: 22.4% silymarin vs 6.0% placebo (p=0.023). Liver stiffness reduction: 24.2% vs 2.3% (p=0.002). Missed primary NASH endpoint but anti-fibrotic signal is clinically meaningful."
      year: 2017
    - title: "Tao et al. - Anti-TB Drug Liver Injury Meta-Analysis"
      finding: "5 RCTs, 1,198 patients. Reduced drug-induced liver injury at week 4 (RR 0.33, 95% CI 0.15-0.75). Protective on ALT, AST, ALP. Adverse events identical to placebo."
      year: 2019
    - title: "Fried et al. SyNCH Trial - Chronic Hepatitis C (JAMA)"
      finding: "154 patients, 24 weeks, 1260-2100 mg/day. No significant improvement in ALT or HCV RNA vs placebo (p=0.75). Definitive NIH-funded negative result at high doses."
      year: 2012

preparations:
  - method: extract
    dosing: "420 mg/day (140 mg three times daily) — standard; up to 2100 mg/day (700 mg three times daily) for severe NAFLD/NASH"
    notes: "Standardized to 70-80% silymarin. All major clinical trials used this form. Take with meals. Legalon (Rottapharm Madaus) is the most clinically validated brand — used in NASH and hepatitis C trials."
  - method: capsule
    dosing: "Phytosome (Siliphos): 160-320 mg/day | Micellar (LipoMicel): 130 mg/day"
    notes: "Enhanced bioavailability formulations. Phytosome: 9.6× higher silybin bioavailability vs standard (23-person RCT). Micellar: 18.9× higher peak levels, 11.4× higher total exposure. Less long-term clinical efficacy data than standard extracts."
  - method: tincture
    dosing: "2-4 mL three times daily (1:5 in 70% ethanol)"
    notes: "Traditional preparation. Not evidence-based — standardized extracts strongly preferred. Silymarin's poor water solubility (<50 μg/mL) also makes seed teas largely ineffective."

trying:
  duration: "Months to years for chronic conditions. The landmark cirrhosis trial ran a mean of 41 months. For drug-induced liver injury prevention, use concurrently with the hepatotoxic drug — protective effects appear within 4 weeks."
  whatToNotice:
    - Liver enzymes (ALT, AST) on blood tests — target 10-12 unit reductions based on NAFLD trial data
    - Fatigue and general energy levels
    - For acute hepatitis — resolution of jaundice or dark urine (faster than expected)
    - Blood glucose if diabetic — may decrease meaningfully
    - Minor GI symptoms (rare, comparable to placebo in most trials)
  notes: "Start with 420 mg/day (140 mg three times daily with meals). For NAFLD with fibrosis or decompensated cirrhosis, clinical trials used higher doses (1050-2100 mg/day). Dose-response is nonlinear — a 5-fold dose increase produces an 11-fold increase in silybin A blood levels and a 38-fold increase in silybin B. Higher doses may provide disproportionately greater benefit."

safety:
  generally: safe
  contraindications:
    - "Allergy to Asteraceae/Compositae plants (ragweed, chrysanthemums, marigolds, daisies) — cross-reactivity possible"
    - "Hormone-sensitive conditions (ER+ breast cancer, endometriosis, uterine fibroids) — theoretical weak estrogenic activity in vitro; clinical significance unclear"
    - "Pregnancy — one small trial showed fetal safety, but insufficient data for routine recommendation"
    - "Breastfeeding — unknown excretion in breast milk; insufficient data"
    - "Pediatric use — no safety data available"
  pregnancyNursing: "One small trial showed safety in pregnancy with no fetal anomalies, but insufficient evidence for general recommendation. Use only if benefits clearly outweigh risks."
  notes: "Excellent safety profile across 26+ clinical trials in thousands of patients. Well tolerated up to 2100 mg/day for 48 weeks — adverse effects comparable to placebo. No absolute contraindications. No cumulative toxicity identified in studies lasting up to 41 months. Low drug interaction potential overall; use caution with narrow therapeutic window drugs (warfarin, digoxin, phenytoin, lithium, theophylline) — monitor drug levels when starting or stopping. May lower blood glucose in diabetics — monitor."

combinedWith:
  - herb: "artichoke"
    why: "Traditional European pairing. Both support bile production and liver health. Artichoke is primarily cholagogue; milk thistle primarily hepatoprotective. Complementary mechanisms."
  - herb: "dandelion"
    why: "Classic liver/gallbladder combination. Dandelion root stimulates bile flow; milk thistle protects hepatocytes. Common in European bitters formulas historically."
  - herb: "turmeric"
    why: "Synergistic anti-inflammatory liver support. Curcumin and silymarin act through complementary antioxidant and anti-inflammatory pathways."

sources:
  - title: "Ferenci et al. - Silymarin in Liver Cirrhosis"
    type: study
    year: 1989
  - title: "Li et al. - Silymarin for NAFLD (26 RCTs)"
    type: meta-analysis
    year: 2024
  - title: "Chan Wah Kheong et al. - NASH Anti-Fibrotic RCT"
    type: study
    year: 2017
  - title: "Fathalah et al. - High-Dose vs Standard Silymarin in Decompensated Cirrhosis"
    type: study
    year: 2017
  - title: "Tao et al. - Silymarin for Anti-TB Drug Liver Injury"
    type: meta-analysis
    year: 2019
  - title: "Fried et al. SyNCH Trial - Chronic Hepatitis C (JAMA)"
    type: study
  ...
  - title: "Saller et al. - Silymarin in Liver Diseases Review"
    type: meta-analysis
    year: 2008
  - title: "Calderon Martinez et al. - Liver Enzyme Review (29 RCTs, 3,846 patients)"
    type: meta-analysis
    year: 2023
  - title: "Kalopitas et al. - Silymarin in NAFLD"
    type: meta-analysis
    year: 2021
  - title: "Hruby et al. - IV Silybin in Amanita Phalloides Poisoning"
    type: study
    year: 1983
  - title: "El-Kamary et al. - Silymarin in Acute Hepatitis"
    type: study
    year: 2009
  - title: "Fatemi Shandiz et al. - Silymarin vs Doxorubicin Hepatotoxicity"
    type: study
    year: 2025
  - title: "Frounchi et al. - Silymarin Nephroprotection Meta-Analysis"
    type: meta-analysis
    year: 2025
  - title: "Voroneanu et al. - Silymarin in Type 2 Diabetes"
    type: meta-analysis
    year: 2016
  - title: "Méndez-Sánchez et al. - Phytosome Bioavailability RCT"
    type: study
    year: 2019
  - title: "Chang et al. - Micellar Silymarin Bioavailability"
    type: study
    year: 2025
  - title: "Hawke et al. - Silymarin Dose-Escalation Pharmacokinetics"
    type: study
    year: 2010
  ...
  - title: "German Commission E - Milk Thistle Monograph"
    ...
    year: 1998
  - title: "ESCOP Monograph - Milk Thistle"
    type: traditional-text
    year: 2009
...
- Toxic liver damage — especially *Amanita phalloides* (death cap) mushroom poisoning
- Dyspeptic complaints (poor digestion, bilious symptoms)
...
**Notable gap**: Milk thistle doesn't appear prominently in Ayurveda or Traditional Chinese Medicine. This appears to be a predominantly European herb. The absence of independent cross-cultural validation (contrast with ginger or turmeric, which appear in multiple unrelated traditions) is worth noting when evaluating the traditional record.
...
| Form | Dose | Notes |
|------|------|-------|
| **Standard extract** (70-80% silymarin) | 420 mg/day (140 mg × 3) | Landmark cirrhosis trial dose; decades of data |
| **Higher dose** (same extract) | 1260-2100 mg/day | Used in NASH fibrosis trials; well tolerated 48 weeks |
| **Decompensated cirrhosis** (same extract) | 1050 mg/day (350 mg × 3) | Standard 420 mg/day shown insufficient in this population [11] |
...
**Week 1 onward** (standard, chronic conditions):
- 420 mg/day (140 mg three times daily with meals)
- Monitor for any GI symptoms — rare, but possible initially

**Escalation for NAFLD/NASH or severe disease:**
- 1260 mg/day: 420 mg three times daily
- 2100 mg/day: 700 mg three times daily (maximum studied dose; well-tolerated for 48 weeks)
- Decompensated cirrhosis specifically: 1050 mg/day (350 mg three times daily)
...
- Liver enzymes (ALT, AST) — get a panel from your doctor if you have liver disease
- Fatigue and general wellbeing (1-10 daily)
...
### Clear Candidates (strong evidence):
- **Alcoholic cirrhosis, Child A severity**: The most significant subgroup from Ferenci 1989 — the survival benefit was sharpest here [1]
- **NAFLD/fatty liver disease**: Consistent enzyme and fat improvements across 26 trials in 2,375 people [2]
- **On hepatotoxic drugs** (anti-tuberculosis medications, doxorubicin chemotherapy): Protective effect well supported [4][5]
- **NASH with fibrosis concern**: Meaningful anti-fibrotic signal at 2100 mg/day — actual structural changes, not just lab numbers [3]
...
- **Hormone-sensitive conditions** (ER+ cancers, endometriosis, uterine fibroids): In vitro data suggests possible weak estrogenic activity; clinical significance is unclear but warrants caution
- **Pregnancy**: One small trial showed fetal safety, but insufficient evidence for routine use; individual risk-benefit assessment required
- **Children**: No pediatric safety data; not recommended
- **On narrow therapeutic window drugs** (warfarin, digoxin, phenytoin, lithium, theophylline): Low overall interaction potential, but monitor drug levels when starting or stopping milk thistle [15]
...
[1] Ferenci et al. 1989. PMID: 2671116
[2] Li et al. 2024. PMID: 38579127
[3] Chan Wah Kheong et al. 2017. PMID: 28419855
[4] Tao et al. 2019. PMID: 30733935
[5] Fatemi Shandiz et al. 2025. PMID: 39110237
[6] El-Kamary et al. 2009. PMID: 19303273
[7] Voroneanu et al. 2016. PMID: 27340676
[8] Frounchi et al. 2025. PMID: 40886393
[9] Fried et al. 2012. PMID: 22797645
[10] Hruby et al. 1983. PMID: 6410590
[11] Fathalah et al. 2017. PMID: 29135373
[12] Méndez-Sánchez et al. 2019. PMID: 30635055
