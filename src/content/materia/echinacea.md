---
name: "Echinacea"
latinName: "Echinacea purpurea, E. angustifolia, E. pallida"
commonNames:
  - purple coneflower
  - coneflower
summary: "North American immune herb for cold prevention and acute treatment. Fresh alcoholic extracts most effective. Best evidence for preventing infections and reducing antibiotic use."
...
traditional:
  ...
  convergent: true
  attributions:
    - source: "Native North American tradition (pre-1600s, documented from 1700s onward)"
      text: "Used by indigenous peoples for infections, wounds, and snakebites. E. angustifolia root was the primary traditional preparation. Plains tribes including Lakota, Cheyenne, and Pawnee documented extensive medicinal use."
    - source: "German Commission E (1978-1998)"
      text: "European medical tradition adopted echinacea in the 20th century, standardizing fresh-pressed E. purpurea aerial parts in 22% alcohol at 900mg. This formed the basis for licensed medical prescribing in Germany."

evidence:
  summary: "Strong evidence for preventing upper respiratory infections (20-42% reduction), particularly in children. Very strong evidence for antibiotic-sparing (70-80% reduction in antibiotic days). Modest evidence for shortening cold duration by 0.5-1.4 days when treatment starts early. Fresh alcoholic extracts of E. purpurea show strongest effects. High-dose loading protocols (10,000-16,800mg day 1) more effective than conventional doses."
  keyStudies:
    - title: "ERA-PRIMA meta-analysis: Echinacea for RTI prevention"
      link: "https://doi.org/10.3390/nu16071011"
      finding: "5,652 participants across 30 trials. Monthly RTI occurrence reduced 32% (RR 0.68), complications reduced 56% (RR 0.44), antibiotic days reduced 71% (IRR 0.29). Fresh E. purpurea alcoholic extracts showed strongest effect (80% antibiotic reduction)."
    - title: "Pediatric echinacea meta-analysis"
      link: "https://doi.org/10.3390/ph18010083"
      finding: "3,169 children across 9 trials. RTI incidence reduced 19% (RR 0.81), antibiotic use reduced 82% (RR 0.18), otitis media reduced 44% (RR 0.56). Adverse events moderately increased but mild."

preparations:
  - method: tincture
    dosing: "Prevention: 2-3ml three times daily (900-1200mg/day). Acute: 5ml every 2-3 hours day 1, then 2-3ml 3-4 times daily"
    notes: "60% ethanol extraction preferred for alkamides. Fresh plant tincture more effective than dried. T-max 30 minutes, highest bioavailability of all forms."
  - method: extract
    dosing: "Prevention: 400-900mg daily continuous up to 6 months. Acute loading: 10,000-16,800mg day 1, then 2,400-5,100mg days 2-7"
    notes: "Standardized to alkamides (0.07-0.9mg), cichoric acid (2.5mg/mL), polysaccharides (25mg/mL). Fresh E. purpurea alcoholic extract shows 80% antibiotic reduction - strongest clinical effect."
  - method: capsule
    dosing: "Prevention: 300-450mg twice daily. Acute: See extract dosing"
    notes: "Tablets have ~25% bioavailability of tinctures but equivalent immunological effect. Convenient for consistent dosing."
...
trying:
  ...
  whatToNotice:
    - Fewer colds during prevention period
    - When you do get sick, symptoms milder and shorter
    - Less likely to need antibiotics for respiratory infections
    - Early acute treatment - symptoms don't progress as severely
    - Children - fewer ear infections, less antibiotic use
    - Signs dose is too high - mild GI upset, skin rash (rare, transient)
...
safety:
  ...
  contraindications:
    ...
    - "Note: Earlier precautions about pregnancy contradicted by 2016 evidence showing no teratogenicity"
  notes: "**Adverse events**: 9-10% rate (same as placebo in 755-person trial). Most common are mild GI upset and transient rashes. **High-dose safety**: 16,800mg/day loading dose showed 12% adverse events vs 6% at standard dose (p=0.19, not significant). **Long-term safety**: Continuous use up to 6 months studied with no toxicological concerns. **Drug interactions**: No significant CYP450 inhibition, no verifiable drug interaction reports. **Pediatric**: Safe in trials with 201-3,169 children, substantial benefits outweigh mild adverse events."

combinedWith:
  - herb: "elderberry"
    why: "Both reduce viral respiratory infections - complementary antiviral + immunomodulatory approach"
  - herb: "zinc lozenges"
    why: "Synergistic cold treatment - echinacea immunomodulation + zinc direct antiviral action"
  - herb: "vitamin C"
    why: "Traditional combination for immune support during acute infections"
  - herb: "NOT recommended with immunosuppressants"
    why: "May counteract immunosuppressive medications through immune modulation"

sources:
  - title: "Gancitano et al. 2024 - ERA-PRIMA meta-analysis"
    link: "https://doi.org/10.3390/nu16071011"
    type: meta-analysis
  - title: "Pham et al. 2025 - Pediatric echinacea meta-analysis"
    link: "https://doi.org/10.3390/ph18010083"
    type: meta-analysis
  - title: "Schapowal et al. 2015 - Recurrent RTI meta-analysis"
    link: "https://doi.org/10.1016/j.ctim.2015.04.002"
    type: meta-analysis
  - title: "Jawad et al. 2012 - 4-month prevention RCT"
    link: "https://doi.org/10.1155/2012/841315"
    type: study
  - title: "Ogal et al. 2021 - Pediatric antibiotic-sparing RCT"
    link: "https://doi.org/10.1007/s00431-021-04049-3"
    type: study
  - title: "WHO Monographs on Selected Medicinal Plants Volume 1 (1999)"
    link: "https://apps.who.int/iris/bitstream/handle/10665/42052/9241545178.pdf"
    type: traditional-text
  - title: "German Commission E Monographs"
    link: "https://chiro.org/Graphics_Box_NUTRITION/FULL/Commission_E_Monographs.html"
    type: traditional-text
...
- **Preventing colds**: Across 30 trials with 5,652 people, monthly cold occurrence dropped 32% (RR 0.68). If you're prone to catching everything going around, you may find yourself getting sick less often [1].
- **Avoiding antibiotics**: This is where echinacea really shines. In children, antibiotic use dropped 82% (201 kids, RR 0.18) [2]. Overall antibiotic treatment days dropped 71% (IRR 0.29), with fresh E. purpurea alcoholic extracts showing an 80% reduction [1]. For parents tired of repeated antibiotic courses for ear infections and respiratory stuff, this matters.
- **Complications**: Respiratory complications (pneumonia, ear infections, sinusitis) dropped 56% (RR 0.44) across trials [1]. In kids specifically, ear infections dropped 44% (RR 0.56, 3,169 participants) [2].
- **Acute treatment**: If you catch a cold early and hit it hard (10,000-16,800mg on day 1), recovery time drops from 11 days to 9.6 days, with better viral clearance (70% vs 53%) [3].
...
### For Prevention (Daily During Cold Season)
...
### For Acute Treatment (First Sign of Cold)

**High-dose loading** (most effective based on 246-person trial [3]):
- Day 1: 10,000-16,800mg at first symptom - yes, this is a massive dose
- Days 2-7: 2,400-5,100mg daily until symptoms resolve

**Conventional acute** (if high-dose isn't feasible):
- Throughout: 2,400mg daily
- Less effective than loading protocol but simpler
...
- **Prevention mode**: How many colds do you get compared to previous seasons? Are they milder? Do they progress to needing antibiotics?
- **Acute treatment**: If you start at first symptoms, does it stop progression? Do you recover faster?
- **For parents**: Fewer trips to urgent care for ear infections? Less antibiotic prescriptions? This is where the data really stands out.
- **Side effects**: Mild GI upset or transient rash can occur (10-12% across studies, similar to placebo rates). Reduce dose if this happens.

## Who This Is/Isn't For

**Best candidates**:
- You catch every cold going around and want prevention
- Kids with recurrent ear infections or frequent antibiotic courses
- High-risk individuals (stressed, immunologically weak, or history of recurrent infections) - 4-month trial in 755 participants showed 49% reduction in recurrent RTI episodes (RR 0.51) [9]
- You want to reduce antibiotic use for yourself or family

**Use with caution or avoid**:
- Severe allergies to ragweed, chrysanthemums, or other asteraceae family plants - rare but potentially serious allergic reactions possible [10]
- Asthma with significant plant allergies (theoretical increased reaction risk)
- Taking immunosuppressants - echinacea's immune modulation may counteract medication
