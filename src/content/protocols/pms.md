---
title: "PMS & PMDD"
summary: "Evidence-based herbal approaches for premenstrual syndrome symptoms including mood changes, pain, breast tenderness, and hormonal regulation."
symptoms:
  - mood swings
  - irritability
  - depression
...
### Tier 4: Limited but Notable Evidence
...
### Traditional Formulas with Clinical Evidence
...
1. Bupleurum (Chai Hu) - soothes liver, promotes Qi flow
2. Angelica (Dang Gui) - nourishes blood, regulates menstruation
3. White Peony (Bai Shao) - nourishes blood, hormonal balance
4. Atractylodes (Bai Zhu) - strengthens spleen, reduces bloating
5. Poria (Fu Ling) - strengthens spleen, calms spirit, water retention
6. Licorice (Gan Cao) - harmonizes formula, enhances other herbs
7. Moutan bark (Mu Dan Pi) - clears heat, invigorates blood
8. Gardenia (Zhi Zi) - clears heat, eliminates irritability
...
### For Predominantly Physical Symptoms (Breast Pain, Cramping, Bloating)
...
### For Predominantly Psychological Symptoms (Depression, Anxiety, Mood Swings)
...
### For Mixed Presentations (Physical + Psychological Symptoms)
...
- Primary formula: Jia-Wei-Xiao-Yao-San [12,13]
- Alternative: Chaihu Shugan Powder [32]
- Key herb: Bupleurum (Chai Hu) [13,32]

**Liver-Spleen Disharmony pattern** (symptoms: fatigue, digestive issues, emotional symptoms, blood deficiency):
- Primary formula: Xiao Yao San (base formula; JWXYS is augmented version) [13]
- Function: Soothe liver, nourish blood, strengthen spleen [13]

**High Prolactin / Low Progesterone pattern** (symptoms: breast pain, luteal phase defect, irregular cycles):
- Primary herbs: [[materia/vitex]] OR White Peony + Licorice combination [5,18,30]
- Both achieve 20-30% prolactin reduction and progesterone increase [5,18,30]

**PCOS-Related PMS** (symptoms: irregular cycles, anovulation, hormonal imbalance):
- Primary: White Peony + Licorice [30]
- Evidence: Normalized menstrual cycles, improved ovulation induction [30]

### Nutrient Synergy Approach
...
### Rotation Strategy for Long-Term Management
...
### Month 1 (Cycle 1): Initial Response Phase

**Fast-acting herbs (symptom relief within 1 cycle):**
- [[materia/ginkgo]]: Breast pain may start improving, p < 0.001 for congestive symptoms within first cycle [20,21]
- Fennel: Dysmenorrhea relief within hours to days, works acutely [26]
- [[materia/chamomile]]: Pain reduction within hours (anti-inflammatory and antispasmodic effects), psychological effects emerging [27,28]
- [[materia/lemon-balm]]: Initial anxiety/mood improvement (-55.5 point reduction in month 1) [23]

**Slower-acting herbs (hormonal regulation beginning):**
- [[materia/vitex]]: Minimal symptomatic change, but hormonal shifts starting (prolactin beginning to decrease, progesterone starting to rise) [17,18]
- White Peony: Prolactin reduction starts (measurable at 4 weeks) [30]
- [[materia/saffron]]: Possible early mood improvement as neurotransmitter modulation begins [16,17]

**Traditional formulas:**
- JWXYS: Initial symptom relief possible, pattern shifts beginning [12,16,17]
...
### Month 2 (Cycle 2): Standard Assessment Point

**This is the gold standard checkpoint in most clinical trials.**

**Expected improvements by cycle 2:**
- [[materia/saffron]]: Significant mood improvements, p < 0.001 versus placebo [10,11]
- [[materia/vitex]]: Noticeable improvements in breast pain, bloating, some mood symptoms [4,17]
- [[materia/ginkgo]]: Continued breast pain and congestive symptom improvement [20,21]
- [[materia/lemon-balm]]: Further improvement (-57.3 point reduction, slightly better than month 1, suggesting cumulative benefit) [23]
- White Peony: Prolactin reduction progressing (approaching 21% reduction from baseline) [30]

**Traditional formulas:**
- JWXYS: Moderate improvements in physical and psychological symptoms [12,17]
...
### Month 3 (Cycle 3): Standard Clinical Trial Endpoint

**Most women with responsive PMS have ≥50% improvement by cycle 3.**

**Expected at cycle 3:**
- Curcumin: Significant reductions in mood, behavioral, and physical symptoms (standard trial duration) [22]
- Fennel: Maximum benefit for pain, lethargy, depression after 3-month protocol [26]
- [[materia/valerian]]: Significant improvements (p < 0.001) in emotional, behavioral, and physical categories [29]
- [[materia/lemon-balm]]: Continued benefit, 3-cycle assessment complete [23]
- [[materia/vitex]]: Significant overall PMS improvement, moving toward remission [4,17]
- JWXYS: Significant improvements (p < 0.01) for both physical and psychological symptoms, pattern shifts evident [12]
- White Peony: Near-maximum prolactin reduction (28% at 8 weeks) [30]

**Clinical checkpoint:**
- **≥50% improvement:** Continuing current protocol or extending to 6 cycles for consolidation is common
- **25-49% improvement:** Partial response; practitioners may add second herb or extend to 6 cycles before changing
- **<25% improvement:** Poor response; reassessing herb selection, dosing, symptom pattern match, or formula approach may be indicated

### Month 6 (Cycle 6): Long-Term Consolidation

**For hormonal regulation and pattern resolution:**

**Expected at cycle 6:**
- [[materia/vitex]]: Maximum benefit, hormonal regulation established, 2.57x remission rate fully manifested [4,17]
- JWXYS: Pattern resolution progressing, not just symptom suppression but underlying disharmony correction [12,17]
- White Peony: Full hormonal rebalancing [30]
...
### Month 12 (Cycle 12): Deep Constitutional Change

**Rarely needed except for:**
- Severe, long-standing PMS (>5 years)
- PMDD with significant functional impairment
- Complex hormonal imbalances (PCOS, perimenopause)
- TCM approach aiming for deep pattern resolution [17]

**Expected at 12 cycles:**
- Traditional formulas: Deep constitutional change, pattern fully resolved in responsive cases [17]
- Hormonal herbs: Lasting changes in cycle regulation, minimal or no PMS symptoms
...
- ≥50%: Continuing protocol is common
- 25-49%: Partial response - extending to 6 cycles or adding complementary herb are options
- <25%: Poor response - changing approach (different herb, formula instead of single herb, addressing root cause like PCOS or thyroid) may be indicated
...
### Timeline by Symptom Type

**Physical symptoms (breast pain, dysmenorrhea):**
- Fast: Ginkgo (1 cycle), Fennel (hours to 1 cycle), Chamomile (hours to days)
- Moderate: Vitex (1-2 cycles for breast pain, 3+ for full effect), Curcumin (3 cycles)
- Mechanism: Analgesic/antispasmodic (hours to days), anti-inflammatory (days to weeks), hormonal prolactin reduction (2-4 weeks to 2 cycles)

**Psychological symptoms (depression, anxiety, mood):**
- Fast: Saffron (2 cycles), Lemon balm (month 1 shows effects, month 2 stronger)
- Moderate: Vitex (2-3 cycles, slower than physical symptoms), Bupleurum formulas (2-3 cycles)
- Mechanism: Neurotransmitter modulation (2-4 weeks to 2 cycles, similar to SSRIs), hormonal effects on mood (2-3 cycles), GABAergic effects (variable: acute for anxiety, chronic for mood stability)

**Congestive symptoms (bloating, water retention):**
- Fast: Ginkgo (1 cycle for congestive symptoms)
- Moderate: JWXYS formula with atractylodes and poria (2-3 cycles for spleen strengthening and dampness resolution)

**Behavioral symptoms:**
- Moderate: Valerian (3 cycles for significant behavioral improvements), St. John's wort (2 cycles for behavioral but not mood)
...
1. **Date and cycle day** (track to identify patterns)
2. **Physical symptoms** (rate 0-10): breast pain, bloating, headache, cramping, fatigue
3. **Psychological symptoms** (rate 0-10): depression, anxiety, irritability, mood swings
4. **Behavioral symptoms** (rate 0-10): food cravings, social withdrawal, concentration difficulty
5. **Sleep quality** (1-10 scale)
6. **Overall functional impairment** (0-10: how much did symptoms interfere with work, relationships, daily life?)

**Herb tracking:**
- Which herb(s) taken
- Dose and timing (luteal phase only vs full-cycle)
- Any missed doses
- Any side effects
...
- Average psychological symptom score
- Average behavioral symptom score
- Average overall impairment score

**Compare baseline (pre-treatment) to treatment cycles:**
- Cycle 1 (baseline): Luteal phase average psychological 7.5/10
- Cycle 2 (on saffron): Luteal phase average psychological 6.2/10 (17% improvement)
- Cycle 3 (on saffron): Luteal phase average psychological 4.8/10 (36% improvement from baseline)

**Pattern identification:**
- Which specific symptoms improved most?
- Which symptoms didn't change?
- Are improvements consistent across cycles or variable?
- Do certain days of luteal phase show more improvement (early vs late)?
...
- Baseline hormone panel: Day 3 FSH/LH/estradiol, Day 21 progesterone, prolactin
- Repeat after 3-6 months of herbs: Compare prolactin (expect 20-30% reduction with vitex or white peony), progesterone (expect increase with vitex)
- Objective confirmation of hormonal mechanism

**Quality of life tracking:**

Beyond symptom scores, track functional outcomes:
- Days of work missed or reduced productivity
- Social activities canceled
- Relationship conflict frequency
- Exercise frequency
- Overall life satisfaction (1-10 monthly rating)
...
- Same dose, same timing (luteal vs full-cycle), every cycle
- Continue tracking all metrics
- Note any side effects or changes

**Cycle 5 (Washout):** Stop herb, continue tracking
- Observe if symptoms return toward baseline
- This confirms the herb effect was real vs placebo or natural cycle variation

**Cycles 6-7 (Confirmation):** Resume herb if it worked
- Replication confirms effectiveness
- If response differs from cycles 2-4, suggests placebo effect or other factors

**What to look for:**

✅ **Success pattern:**
- Consistent improvement during treatment cycles 2-4
- Return toward baseline during washout cycle 5
- Improvement again when resumed in cycles 6-7
- Example: Breast pain average 7/10 (baseline) → 4/10 (cycles 2-4) → 6/10 (washout) → 3/10 (cycles 6-7)

❌ **No effect pattern:**
- Random good/bad cycles throughout all phases
- No clear difference between baseline, treatment, washout, and resumption
- Example: Mood scores bounce between 4-8/10 in all phases with no pattern

❌ **Worsening pattern:**
- Symptoms worse during treatment
- Improve during washout
- Example: Anxiety 5/10 (baseline) → 7/10 (treatment) → 4/10 (washout)
...
- **Symptom severity:** 30-50% reduction in luteal phase symptom averages
- **"Bad days":** Reduced from 7-10 days per cycle to 2-4 days per cycle
- **Functional impairment:** Reduction from "cannot work" or "cancel plans" to "manageable with effort"
- **Quality of life:** Rated ≥7/10 most months
- **Cycle regularity:** Improved predictability (for irregular cycles)
...
- More good days than bad days during luteal phase (ratio improves)
- Bad days are less severe than pre-treatment (7-8/10 becomes 3-4/10)
- Functional impairment is minimal (can work, maintain relationships, exercise)
- No longer dreading the luteal phase or planning life around PMS

**Maintenance patterns in clinical practice:**
- Some women continue herbs long-term (years) with sustained benefits
- Others reduce dose or switch to luteal-only after 6-12 cycles
- Some achieve lasting hormonal regulation and discontinue use
- Having herbs available for occasional cycles if symptoms recur is a common approach

### When to Seek Medical Evaluation

**PMS symptoms warrant healthcare consultation if:**

- Severe functional impairment (missing work/school, relationship damage, suicidal thoughts)
- Symptoms persist beyond day 3 of menstruation (may not be PMS; could be depression, anxiety disorder, or other condition)
- New onset after age 35-40 (consider perimenopause, thyroid, other hormonal changes)
- Symptoms worsen progressively over time despite herbal treatment
- Irregular cycles making it impossible to predict symptoms (check for PCOS, thyroid)
- Physical symptoms like severe pelvic pain (rule out endometriosis, fibroids)

**PMDD specifically (severe form):**
- Marked depressive symptoms, severe anxiety, or mood instability
- Significant functional impairment in work or relationships
- Suicidal ideation during luteal phase
- Symptoms confirmed across 2+ cycles using validated PMDD screening tool
...
- Baseline: Day 3 FSH/LH/estradiol, Day 21 progesterone, anytime prolactin
- If PCOS suspected: Testosterone, DHEA-S, fasting insulin
- If thyroid suspected: TSH, free T3, free T4
- After 3-6 months on herbs: Repeat prolactin and progesterone to confirm hormonal changes
...
**Vitex:**
- May cause menstrual changes in first 2-3 cycles (expected hormonal adjustment)
- Rare reports of acne or skin reactions
- Affects prolactin - avoid in prolactinoma or if taking dopamine agonists
- May interfere with dopamine antagonist medications (antipsychotics, metoclopramide)

**Saffron:**
- High doses (>5 grams) are toxic - use standardized extracts at recommended doses (30 mg/day)
- Combination with SSRIs requires medical supervision (serotonin syndrome risk)
- May cause mild dizziness or drowsiness in sensitive individuals
- Pregnancy contraindication (traditional use as abortifacient at high doses)

**Ginkgo:**
- Mild antiplatelet effect - caution with bleeding disorders or anticoagulants
- Rare reports of headache or GI upset
- May interact with some seizure medications

**Curcumin:**
- Can cause GI upset if not taken with food
- Piperine (black pepper extract) enhances absorption but may affect drug metabolism - caution with medications
- Mild anticoagulant effect - monitor if on blood thinners

**Lemon balm:**
- Generally very safe
- May cause mild drowsiness in some individuals
- Theoretical interaction with thyroid medications (may reduce TSH) - monitor thyroid function

**Valerian:**
- May cause drowsiness - caution advised when driving or operating machinery
- Some people experience paradoxical stimulation (increased alertness) - discontinue if occurs
- Combination with sedative medications (benzodiazepines, sleep medications, opioids) requires medical oversight

**Traditional formulas (JWXYS):**
- Generally safe with minimal side effects in trials [12]
- Practitioner modification of formulas can optimize safety and efficacy
- Some components contraindicated in pregnancy (bupleurum, angelica, moutan bark)
...
1. **Standardized extracts when available:**
   - Vitex: standardized to dopaminergic compounds or agnuside content
   - Saffron: standardized to crocin and safranal content
   - Ginkgo: EGb 761 or 24% ginkgo flavone glycosides, 6% terpene lactones
   - Curcumin: with piperine or other absorption enhancers
...
2. **Third-party testing verification:**
   ...
   - Confirms herb content matches label claims
...
4. **Traditional formula considerations:**
   - Source from reputable TCM pharmacies or practitioners
   - Proper species identification is important (especially for bupleurum, white peony, angelica)
   - Classical formulas from established manufacturers (Kan Herbals, Plum Flower, etc.)
...
- Symptom tracking journal (see N=1 section)
- Menstrual cycle regularity and flow
- Any new symptoms or side effects
- If using hormonal herbs long-term (6+ months): periodic hormone testing (prolactin, progesterone)

**Seek medical attention if:**
- Worsening PMS symptoms despite 3+ cycles of optimal herbal treatment
- New onset of severe symptoms (suicidal thoughts, inability to function)
- Irregular or absent menstrual cycles (rule out pregnancy, PCOS, thyroid, perimenopause)
- Severe pelvic pain (rule out endometriosis, fibroids, ovarian cysts)
- Abnormal bleeding (very heavy, prolonged >7 days, bleeding between periods)
- Symptoms persist beyond day 3 of menstruation (may not be PMS)
- Severe side effects from herbs
