...
summary: "Evidence-based herbal approaches for seasonal and year-round allergies, from sneezing to itchy eyes."
symptoms:
  - allergies
  - hay fever
  - allergic rhinitis
...
- Sneezing: 83% of people got complete relief
- Nasal discharge: 69% complete relief
- Nasal obstruction: 61% complete relief
- Nasal itching: 71% complete relief
...
| Symptom | Best Option | Runner-Up | Why |
|---------|-------------|-----------|-----|
| Sneezing | Tinospora (83% complete relief) [6] | Black cumin (41.5% improvement) [9] | Tinospora has highest documented complete relief rates |
| Congestion | [[materia/butterbur]] [1] | Reishi [12] | Butterbur beats antihistamines specifically for congestion |
| Eye symptoms | perilla [5] | Quercetin [13] | Perilla documented best for ocular symptoms |
| Runny nose | [[materia/astragalus]] (p=0.048) [11] | Tinospora (69% complete) [6] | Astragalus has strongest statistical evidence |
| All symptoms | Tinospora [6] | [[materia/ashwagandha]] + Curcumin combo [4] | Highest complete relief rates across the board |
...
- **Combination**: 31.62% total symptom reduction
- **Single curcumin**: 0% total symptom reduction
...
- Multiple symptoms of equal severity
- Previous single herb trials gave partial/inadequate results
- Chronic or year-round allergies
- Want sustained long-term improvement

**When to stick with single herbs:**
- One dominant symptom (go symptom-specific)
- First trial of herbal treatment
- Acute seasonal allergies with clear trigger
- Prefer simplicity

## Expected Timeline

**Rapid response (2-4 weeks):**
- [[materia/butterbur]]: 2 weeks to match antihistamines [1,2]
- Black cumin: 15-30 days [9]
- perilla: 3 weeks [5]
- Stinging nettle: 2-4 weeks [15]

**Moderate timeline (4-6 weeks):**
- Quercetin: 4 weeks [13]
- [[materia/astragalus]]: 6 weeks [11]

**Full effect (8+ weeks):**
- Tinospora: Improvements begin week 4, full effect week 8 [6,8]
- [[materia/reishi]]: 8 weeks [12,8]
- Traditional formulas (CS, Yu-ping-feng San): 8+ weeks with sustained benefits [10]
...
- [[materia/butterbur]] (PA-free) 1 tablet 4x daily
- Safe for 2-4 weeks, up to 8 weeks maximum [1,7,8]

**Can wait 3-4 weeks:**
- perilla 200mg daily (especially for eye symptoms) [5]
- Black cumin 250-500mg oil 1-2x daily [9]
- Quercetin 200mg daily (eyes, sneezing) [13]

### Year-round allergies making you miserable?

Commit to 8 weeks:
- Tinospora 300mg 3x daily (61-83% complete relief) [6]
- OR CS formula (strongest TCM evidence, sustained effects) [10]
- For runny nose: [[materia/astragalus]] 80mg for 6 weeks [11]
- For congestion: [[materia/reishi]] 2g twice daily for 8 weeks [12]

### Want to prevent allergies before season starts?

Start 4-8 weeks early:
- Yu-ping-feng San (Jade Windscreen) - builds immune "windscreen" [10]
- Stinging nettle 300mg twice daily (begin 1-2 weeks before season) [15]
- Can add: Low-dose elderberry 600mg daily for year-round support

### Currently taking antihistamines?

Consider switching:
- [[materia/butterbur]] equals cetirizine/fexofenadine with better tolerability [1,2]
- Spirulina 2g daily may be superior to cetirizine (32% IL-4 reduction) [16]

### Currently using steroid nasal spray?

Trial comparison:
- Black cumin showed effects comparable to mometasone (steroid spray) in animal studies [9]
...
**Proven synergy:**
- [[materia/ashwagandha]] + Curcumin: 31.62% symptom reduction (vs 0% for curcumin alone) [4]
- Traditional formulas outperform single herbs consistently [10,14]

**Safe symptom-specific pairings:**
- perilla 200mg (eyes) + [[materia/astragalus]] 80mg (runny nose)
- [[materia/butterbur]] 4x daily (congestion) + Quercetin 200mg (eyes)

**Formula + single herb for dominant symptom:**
- CS formula + perilla 200mg (if severe eye symptoms)
- Yu-ping-feng San + [[materia/butterbur]] 4x daily (if severe congestion)
...
| Herb | Primary Action | Best For | Timeline | Strength of Evidence |
|------|----------------|----------|----------|---------------------|
| [[materia/butterbur]] | COX-2 inhibitor, anti-leukotriene [1] | Congestion, fast relief | 2 weeks | Strong (multiple RCTs vs antihistamines) |
| Tinospora | Mast cell stabilizer, multi-mechanism [6] | All symptoms, comprehensive | 8 weeks | Strong (exceptional complete relief rates) |
| perilla | Antihistamine, stronger than cromoglycate [5] | Eye symptoms | 3 weeks | Strong (vs pharmaceutical) |
| Black cumin | IgE suppressor, Th2 reducer [9] | Nasal + eye symptoms | 15-30 days | Strong (meta-analysis, 7 RCTs) |
| Quercetin | Mast cell stabilizer, H1 antagonist [13] | Eye itching, general | 4 weeks | Moderate (66-person RCT) |
| [[materia/astragalus]] | Immune modulator (Th1/Th2 balance) [11] | Runny nose, chronic | 6 weeks | Moderate (48-person RCT) |
| [[materia/reishi]] | Immune modulator, anti-inflammatory [12] | Chronic congestion | 8 weeks | Limited human data, strong animal |
| Stinging Nettle | H1 antagonist, tryptase inhibitor [15] | Prevention, general | 2-4 weeks | Moderate (patient satisfaction data) |
| Spirulina | IL-4 reducer, antioxidant [16] | General (possible antihistamine alternative) | Unknown | Limited but promising |

**Traditional Formulas:**
| Formula | Tradition | Best For | Evidence |
|---------|-----------|----------|----------|
| Cure-Allergic-Rhinitis Syrup (CS) | TCM | Chronic, sustained relief | Strong (249-person RCT, 3-month follow-up) [10] |
| Yu-ping-feng San | TCM (classical) | Prevention, immune building | Moderate (same trial, smaller effects than CS) [10] |
| [[materia/ashwagandha]] + Curcumin | Modern | Multiple symptoms, synergy | Moderate (proven synergy vs single herb) [4] |
| IMMBO | Ayurveda | General | Moderate (superior to standard medication) [14] |
...
- Rate each symptom 0-10: sneezing, congestion, runny nose, eye itching, overall misery
- Note: What time of year? What's your typical trigger?
- Previous treatments tried and results

**Weekly tracking:**
- Same symptom scores (0-10 each)
- Any side effects?
- Quality of life: days you felt "normal" vs "dealing with allergies"

**Decision points:**
- Week 2: If using butterbur/nettle, should see improvement. If not, verify PA-free extract (butterbur) or adequate dose (nettle)
- Week 4: If using black cumin/perilla/quercetin, should see clear benefits. If partial, continue to week 6-8. If none, switch approach.
- Week 6: If using astragalus, check runny nose improvement. If minimal, may need full 8 weeks or different herb.
- Week 8: If using tinospora/reishi/formulas, this is full effect point. If inadequate, consider combination or consult practitioner.

**What to notice:**
- Which symptoms improved most? (Might guide future herb selection)
- When did improvement start? (Faster or slower than expected?)
- Did relief continue after stopping? (Suggests immune rebalancing vs symptom suppression)
...
- **[[materia/butterbur]]:** CRITICAL - only PA-free extracts (hepatotoxicity risk from unpurified) [7]. 3.8% adverse events, mostly mild GI [8]. Maximum studied: 8 weeks.

- **Tinospora:** Minimal adverse events (2/36 nasal pain, 1/36 headache, resolved with analgesics) [6]. No discontinuations required. 8 weeks studied.

- **perilla:** Zero adverse events in trials, normal blood tests [5]. Extremely safe profile.

- **Black cumin:** 250 mg/day for 2 weeks showed no adverse effects [9]. Well-tolerated across trials.

- **Quercetin:** Well-tolerated at studied doses [13]. Note: bioavailability can be low - lecithin formulations may help.

- **[[materia/astragalus]]:** Safe for long-term use. May interact with immunosuppressants [11].

- **[[materia/reishi]]:** No adverse effects vs placebo in 10-day human safety study [12].

- **Stinging Nettle:** Well-tolerated, minimal adverse events [15]. Occasional allergic reactions in people with plant allergies.

**General cautions:**
- Pregnancy/breastfeeding: Consult healthcare provider (insufficient data for most herbs)
- Liver disease: Avoid butterbur unless verified PA-free [7]
- Immunosuppressants: Use caution with immune-modulating herbs (astragalus, reishi)
- Surgery: Stop herbs 2 weeks before due to theoretical bleeding risk (especially ginger combinations)

**Long-term use (>8 weeks):**
Limited safety data beyond 8 weeks for most herbs [8]. If considering extended use, consult practitioner and monitor for adverse effects. Traditional formulas (TCM, Ayurvedic) are often used longer-term under professional guidance.
