...
summary: "Evidence-based herbal approaches for chronic stress, adrenal fatigue, burnout, and HPA axis dysregulation."
symptoms:
  - chronic fatigue
  - mental exhaustion
  - anxiety
...
- **Rhodiola:** Cortisol response modulation, energizing [12,14]
- **Ashwagandha:** Direct cortisol reduction, calming [7,8]
- **Panax Ginseng:** HPA axis stabilization, prevents neurotransmitter depletion [16,17]
...
- **Astragalus (Huang Qi):** Most important qi (life force) tonifying herb [38]
- **Cordyceps:** Tonifies Kidney yang, supports physical stamina and energy [38]
- **Eleuthero:** Enhances nervous system function, improves fatigue response [38]
- **Dong Quai (Angelica sinensis):** Nourishes blood, often combined with qi tonics [38]
...
|------|-------------------|----------|------------------|----------------|------|----------|
| [[materia/ashwagandha]] | Direct cortisol reduction, GABAergic | High anxiety + sleep issues | Highest - Review of 25 RCTs [7], Meta-analysis [8] | Days-weeks (calming); 56-60 days (cortisol) | 300mg 2x/day | 56-60 days |
| [[materia/rhodiola]] | Cortisol response modulation, energizing | Mental fatigue, burnout, performance | Highest - Phase III RCT [12], German study 330 patients [2] | 4 weeks (performance); 8 weeks (burnout) | 576mg/day | 4-8 weeks |
| Holy Basil | Long-term HPA dampening + acute buffering | Balanced calm/focus, general stress | High - RCT 100 volunteers [9], Review 24 studies [15] | Weeks (acute); 8 weeks (full HPA) | 125mg 2x/day | 8 weeks |
| Panax Ginseng | HPA stabilization, neurotransmitter protection | Concentration under stress, HPA dysregulation | Good - RCTs [16,17], HPA review [18] | 6-8 weeks | 2g/day | 6-8 weeks |
| Eleuthero | Endurance, mental acuity in fatigue | Chronic fatigue syndrome | Good - Double-blind RCT 96 patients [13], Review [22] | 2 months | 1,000mg/day | 2 months |
| [[materia/bacopa]] | Acute cortisol buffering + chronic cognitive | Acute stress, elderly cognition | Good - Acute study [24], 12-week RCT [25] | 1 dose (acute); 8-12 weeks (chronic) | 320-640mg (acute); 300mg/day (chronic) | Acute or 8-12 weeks |
| [[materia/schisandra]] | HPA balancing, BDNF upregulation | Combination use, depression in stress | Moderate - Animal studies [19,20] | Variable (in combos) | In formulas | Variable |
| [[materia/reishi]] | Serotonin via gut microbiota, sleep | Neurasthenia, sleep in burnout | Moderate - Neurasthenia study [29], Animal sleep studies [30] | 6-8 weeks | 1,800-5,400mg/day | 6-8 weeks |
| Licorice | Cortisol-sparing (11β-HSD2 inhibition) | Low cortisol states (supervised only) | Moderate mechanism [32]; Safety concern [33] | Variable | Supervised | Supervised |
| Rhodiola + Ashwagandha | Energizing + calming synergy | Complex burnout, balanced support | High theoretical + separate RCT evidence [2,7,36] | 4-8 weeks | 576mg + 600mg | 8 weeks |
| TCM formulas (Xiao Yao San, Bu-Zhong-Yi-Qi-Tang, Sijunzi) | Pattern-based multi-herb | TCM pattern diagnosis | Moderate-Good - RCTs exist [10,11], reviews [34] | 2+ months | Pattern-specific | 3-6 months |
...
- Initial cortisol modulation begins [7,8]
- Acute stress buffering mechanisms activate [9,24]
- Neurotransmitter levels start shifting [6,17]

**Subjective experience:**
- Ashwagandha users: "Feeling calmer" or "sleeping better" [8,14]
- Bacopa users: Improved mood after single dose [24]
- Holy basil users: Lower subjective stress during stressors [9]

**Who responds early:**
- Ashwagandha for anxiety (calming felt within days to weeks) [8]
- Bacopa for acute stress (works within hours) [24]
- Holy basil for acute stress buffering (measurable within weeks) [9]

**Who doesn't respond yet:**
- Rhodiola (needs 4+ weeks) [12]
- Eleuthero (requires 2 months) [13]
- Full cortisol normalization for any herb (requires weeks to months) [7]
...
- Rhodiola Phase III trial: Significant effects on burnout scale and attention at 4 weeks (576mg daily) [12]
- Holy basil: Measurable improvements in acute stress response (weeks), though full HPA dampening requires 8 weeks [9]

**Expected improvements by 1 month:**
- Mental performance: Improved concentration, attention under stress [12]
- Stress reactivity: Reduced cortisol spike to stressors [9,12]
- Energy: Less mental fatigue [12,22]

**If no improvement by week 4:**
- Rhodiola, Bacopa, Panax Ginseng users should see some effect by this point
- Ashwagandha users should feel calming/sleep benefits (full cortisol normalization takes longer)
- Eleuthero users need to continue (2-month timeline) [13]
- Consider wrong herb for symptom pattern or dose too low

### Week 8-12: Long-Term HPA Normalization

**Best for:**
- Full burnout recovery [2]
- Chronic stress with HPA axis dysregulation [7,9]
- Severe cortisol dysregulation [7]

**What changes at 2-3 months:**
- Glucocorticoid receptor sensitivity fully restored [4]
- HPA axis negative feedback loop functioning properly [4]
- Cortisol rhythms normalized [7]
- Neurotransmitter systems rebalanced [6,17]

**Evidence at 8 weeks:**
- Rhodiola German study: "Considerable alleviation" of exhaustion, depression, insomnia, fatigue, performance drop in 330 burnout patients [2]
- Holy basil: Hair cortisol significantly lower (long-term HPA dampening), sleep improved [9]
- Panax Ginseng: Full neurotransmitter stabilization [17]

**Evidence at 56-60 days:**
- Ashwagandha: Significantly decreased serum cortisol and Perceived Stress Scale scores [7]

**Who needs this timeline:**
- Chronic severe stress (>6 months)
- Burnout with multiple symptoms (exhaustion + depression + insomnia + performance decline) [2]
- Cortisol dysregulation requiring receptor-level changes [4,7]
...
**Who needs this timeline:**
- CFS patients [13]
- Those using TCM formulas (Xiao Yao San, Bu-Zhong-Yi-Qi-Tang, Sijunzi) [10,11,38]
- Severe depletion requiring constitutional rebuilding [38]
...
- The underlying stress may not be resolved
- Resume herbs (they remain effective on restarting)
- Consider longer treatment duration (3-6 months)
- Address root causes (stress management, lifestyle factors, underlying conditions)
...
- Average perceived stress score
- Average energy level (AM, PM, overall)
- Average sleep quality score
- Number of "good days" (stress ≤5, energy ≥7) vs "bad days" (stress ≥8, energy ≤4)
- Mood stability (range from lowest to highest mood score)

**Pattern identification:**
- Which days are best/worst?
- Correlation with work deadlines, social events, sleep quality?
- Do certain herbs consistently improve specific metrics?
- Time-of-day patterns (morning energy, evening crash, etc.)?
...
- For ashwagandha, full 8 weeks needed for cortisol normalization [7]
- For rhodiola, assess at 4 weeks and 8 weeks [2,12]

**Week 11-12 (Washout):** Stop herb, continue tracking
- Observe if metrics return toward baseline
- Note any changes (should not have rebound worsening [7])
...
✅ **Success pattern:**
- Consistent improvement during "on" weeks (lower stress scores, higher energy, better sleep)
- Return toward baseline during washout
- Improvement again when resumed
- Example: Stress 7.5/10 (baseline) → 5.2/10 (on herb) → 6.8/10 (washout) → 5.0/10 (resume)

❌ **No effect pattern:**
- Random fluctuation throughout all phases
- No clear difference between on/off weeks
- Example: Stress bounces between 5-8/10 throughout all phases regardless of herb use

❌ **Worsening pattern:**
- Metrics worsen during treatment
- Improve during washout
- Example: Energy 6/10 (baseline) → 4/10 (on herb) → 6.5/10 (washout)
- This means wrong herb for your pattern - try different approach

### What "Success" Actually Looks Like

**Realistic targets after 8-12 weeks of treatment:**

- **Perceived stress:** 30-50% reduction in average daily stress score
- **Energy:** Stable throughout day (no severe afternoon crashes)
- **Sleep:** Sleep quality rated ≥7 on most nights
- **Mental clarity:** Able to focus and concentrate during work/tasks
- **Mood:** Mood stability - less irritability, fewer mood swings
- **Stress resilience:** Able to handle stressors without complete overwhelm
...
- More good days than bad days (ratio improves)
- Bad days are less severe and shorter than before treatment
- Daytime function is restored (work performance, relationships, self-care)
- Sleep is restorative most nights
- Stress reactivity is manageable (stressors don't trigger complete dysregulation)
...
Common mismatches:
- Using calming herbs (ashwagandha) for mental fatigue → needs energizing herb (rhodiola) [8,14]
- Using energizing herbs (rhodiola) for anxiety-insomnia → needs calming herb (ashwagandha) [8,14]
- Using general adaptogens for CFS → eleuthero has strongest evidence [13]

**Fix:** Match mechanism to dominant symptom:
- High anxiety + sleep issues → Ashwagandha [7,8]
- Mental fatigue + performance demands → Rhodiola [2,12]
- Burnout (complex) → Rhodiola or Rhodiola + Ashwagandha [2,36]
- Chronic fatigue syndrome → Eleuthero [13]
- Balanced approach → Holy Basil or Rhodiola + Ashwagandha [9,36]

**Question 2: Dose too low?**

Studies showing effectiveness used specific doses:
- Ashwagandha: 300mg 2x/day (600mg total) [7]
- Rhodiola: 576mg/day (SHR-5 extract) [12]
- Holy Basil: 125mg 2x/day (250mg total) [9]
- Eleuthero: 1,000mg/day standard effective dose [13]
...
- Bacopa: 1 dose for acute effects [24]
- Ashwagandha: Days-weeks for calming; 56-60 days for cortisol [7,8]
- Rhodiola: 4 weeks minimum, 8 weeks for burnout [2,12]
- Holy Basil: 8 weeks for full HPA dampening [9]
- Eleuthero: 2 months for CFS [13]
- TCM formulas: 2+ months [38]
...
**Fix:**
- Use well-studied commercial products when available (SHR-5 for rhodiola [12], KSM-66 or Sensoril for ashwagandha [7])
- Look for standardized extracts (ensures batch-to-batch consistency)
- Third-party testing verification (USP Verified, NSF Certified, ConsumerLab)

### Consider Switching to Combinations

Some evidence suggests combination formulas may provide broader benefits:
- Rhodiola + Ashwagandha: "Complementary adaptogens—ashwagandha more calming, rhodiola more energizing—together supporting steady, calm focus under stress" [36]
- Rhodiola + Schisandra + Eleuthero: Reduces fatigue, improves mental accuracy [35]
- TCM formulas: Address multiple pattern components simultaneously [10,11,34]

**Try switching from:**
- Single herb → Rhodiola + Ashwagandha combination [36]
- Western herb → TCM pattern-based formula [10,11,34]
- Simple protocol → Multi-herb formula addressing multiple mechanisms [37]

### Rule Out Underlying Medical Conditions

**Healthcare evaluation recommended for:**

- **Severe fatigue unresponsive to adaptogens** → check thyroid function (TSH, free T3, free T4), vitamin D, B12, iron, ferritin, inflammatory markers
- **Suspected adrenal insufficiency** → formal cortisol testing (morning cortisol, ACTH stimulation test if indicated) - licorice-only approach requires diagnosis [32,33]
- **Depression with stress** → may need integrated psychiatric treatment (antidepressants + adaptogens)
- **Severe insomnia** → see [[protocols/sleep]] for sleep-specific protocols
- **Unintentional weight changes, heat/cold intolerance** → thyroid dysfunction
...
- Mild-to-moderate stress and burnout
- Functional HPA axis dysregulation (not primary endocrine disease)
- As part of multimodal treatment (herbs + stress management + lifestyle + therapy)
- People who cannot tolerate or prefer to avoid pharmaceuticals

**Adaptogens may NOT be sufficient for:**
- Severe major depression (needs psychiatric medication + therapy)
- Severe anxiety disorders (GAD, panic disorder may need medication)
- Primary endocrine disorders (hypothyroidism, adrenal insufficiency needs hormone replacement)
- Acute crisis situations (severe burnout with work disability may need medical leave + intensive treatment)
...
- Holy Basil: "Well tolerated with no significant adverse effects" in 8-week trial [9]
- Ashwagandha: Generally well-tolerated in clinical trials [7,8]
- Rhodiola: Good safety profile in clinical studies [2,12]
- Bacopa: Safe in elderly populations over 12 weeks [25]
...
**Ashwagandha:**
- May lower blood sugar (monitor if diabetic) [14]
- May affect thyroid function (monitor TSH, free T3, free T4) [14]
- Taper over 1-2 weeks if used >3 months (allows HPA axis to re-adapt) [14]
- Theoretical concern in autoimmune conditions [14]

**Licorice:**
- Hepatotoxicity concern - can cause pseudohyperaldosteronism (high BP, electrolyte imbalances) [33]
- Not suitable for long-term unsupervised use [33]
- Avoid if hypertension, heart disease, kidney disease, or low potassium [33]
- Monitor blood pressure and electrolytes if using under supervision [33]

**Rhodiola:**
- Energizing effect may worsen insomnia if taken late in day - take in morning [14]
- May cause overstimulation in sensitive individuals - start with low dose

**Panax Ginseng:**
- May cause overstimulation, insomnia if taken late in day
- Caution in hypertension (may elevate blood pressure in some individuals)
...
- Stress and symptom journal (see N=1 tracking section)
...
- Worsening symptoms despite optimal herbal treatment
- New severe symptoms (suicidal thoughts, severe depression, panic attacks)
- Signs of thyroid dysfunction (significant weight changes, heat/cold intolerance, heart palpitations)
- Signs of liver issues (jaundice, dark urine, severe abdominal pain)
- Severe hypertension or electrolyte issues (if using licorice)
