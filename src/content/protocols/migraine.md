---
title: "Migraine"
summary: "Evidence-based herbal approaches for migraine prevention, acute treatment, and symptom management."
symptoms:
...
### Tier 1: Highest Evidence Quality (Meta-Analyses + Large RCTs)
...
### Tier 2: Good Evidence (RCTs + Traditional Validation)
...
### Tier 3: Promising Evidence (Smaller RCTs, Traditional Use)
...
### Tier 4: Traditional Medicine Formulas
...
### For Acute Migraine Attack (Pain Relief)
...
- **0 minutes (onset)**: Apply peppermint 10% topical to forehead/temples
- **0 minutes**: Take ginger 250-500mg OR feverfew + ginger sublingual
- **15 minutes**: Lavender inhalation (2-4 drops, 15 minutes) if preferred or if nausea/anxiety component [24]
...
### For Migraine Prevention (Frequency Reduction)
...
- **Nano-curcumin 80mg daily** (OR standard curcumin 500mg bid if nano-curcumin unavailable)
...
### For Migraine with Sleep/Anxiety Component

**First-line: Lavender Aromatherapy + CoQ10**

- **Lavender aromatherapy daily** for 3 months (prophylaxis) [25]
- **CoQ10 400mg daily** for mitochondrial support [10]
- **Lavender inhalation** (2-4 drops, 15 minutes) during acute attacks [24]
...
### Special Case: Refractory Migraine (Failed Other Options)
...
### Pattern-Based Traditional Chinese Medicine Approach
...
**Months 1-3:** CoQ10 400mg daily [10]
**Months 4-6:** Nano-curcumin 80mg daily [12]
**Months 7-9:** CoQ10 300mg + Omega-3 1000-2000mg [12]
**Months 10-12:** Magnesium 600mg + Riboflavin 400mg + CoQ10 150mg [31]
...
## Acute vs Prevention Comparison
...
### Acute Treatment: Minutes to Hours

**Fastest (0-15 minutes):**
- **Peppermint topical**: Immediate to 15 minutes [18]
- **Lavender inhalation**: 15 minutes [24]

**Standard (30 minutes to 2 hours):**
- **Ginger**: 2 hours for pain-free state [9]
- **Feverfew + Ginger sublingual**: 30 minutes to 2 hours [13]
- **Chamomile topical**: 30-60 minutes for nausea/vomiting control [35]

All acute treatments work within a single migraine attack. The 2-hour endpoint is standard in migraine clinical trials [9].

### Prevention: 2-4 Months Minimum
...
- GABA receptor sensitivity changes (valerian if used) [23]
- Mitochondrial enzyme activity increasing (CoQ10, riboflavin) [10,31]
- Anti-inflammatory effects starting (curcumin) [6]
- **Most people see minimal change** - this is normal and expected

**Week 4-8: Early response phase**
- Some individuals begin noticing effects
- Curcumin: 8 weeks minimum for standard formulation [6,21]
- Nano-curcumin: Effects may begin week 3-4 [12]
- **If no improvement by week 8** with curcumin-based protocols, reassess dose or consider different mechanism

**Month 2-3: Standard assessment point**

This is when most preventive treatments reach effectiveness:

- **CoQ10**: Superior to placebo by **third month** [10]
- **Nano-curcumin combo**: 2 months minimum [12]
- **Magnesium + Riboflavin + CoQ10**: 3 months [31]
- **Lavender prophylaxis**: 3 months [25]
- **HERBAMIG**: 3 months [28]

**Expected improvements at 2-3 months:**
- Migraine frequency reduced 30-50% (responders)
- Attack severity reduced 30-50%
- Duration shortened
- CoQ10 specifically: 56.7% frequency reduction, 46.6% severity reduction, 60.0% duration reduction in women's RCT [16]
- Acute medication use decreased

**Month 4-6: Long-term stabilization**

- **Butterbur**: Minimum 4 months for full effect [11]
- **TCM formulas**: 3-6 months typical [14,37]
- **Feverfew + Willow**: 12 weeks showed 61.7% reduction [27]
- Continued improvement beyond month 3 as adaptations deepen

**Who needs longer timelines:**
- Severe chronic migraine (years of duration)
- Complex patterns requiring constitutional correction (TCM approach)
- Those using adaptogenic combinations

**Who responds faster:**
- Mild-moderate migraine
- Nano-curcumin formulations (enhanced bioavailability) [12]
- Younger individuals with shorter migraine history

### Combination Timeline Strategy

When using multiple herbs simultaneously:

**Month 1-3:** Establish baseline prevention (e.g., CoQ10 400mg)
**Month 3:** Assess response. If insufficient (e.g., <30% improvement), add second mechanism
**Month 3-6:** Continue baseline + add synergistic component (e.g., add omega-3 + nano-curcumin to existing CoQ10)
...
### When to Conclude "Not Working"

**For acute treatments:**
- If tried 3+ times during attacks with no benefit within 2 hours, likely non-responder to that herb
- Try different mechanism (e.g., if peppermint fails, try ginger; if ginger fails, try feverfew + ginger combination)

**For preventive treatments:**
- **Do not conclude before minimum timeline** (2-4 months depending on herb)
- After adequate trial:
  - CoQ10: If zero improvement after 3 months at 400mg daily, consider non-responder
  - Curcumin: If zero improvement after 8 weeks standard or 2 months nano-curcumin, reassess
  - Combinations: If zero improvement after 3-6 months, consider different approach
...
Options:
1. **Continue indefinitely** - Most preventive herbs safe long-term based on traditional use and clinical trial data [10,28,37]
2. **Taper and reassess** after 6-12 months - Gradually reduce dose over 4 weeks, monitor if migraine frequency returns
3. **Intermittent maintenance** - Use preventive herbs during high-risk periods (e.g., hormonal migraines only during menstruation week)

**If migraines return after stopping:**
- Resume herbs (they remain effective on restarting)
- Consider longer treatment course (some people need 12-24 months)
- Assess ongoing triggers (stress, sleep, diet) that may need addressing
...
## N=1 Tracking: Building Your Personal Evidence
...
2. **Aura present?** (yes/no, describe if yes)
3. **Location** (unilateral/bilateral, which side)
4. **Pain severity** (0-10 scale at onset, peak, and resolution)
5. **Duration** (hours or days until resolution)
6. **Associated symptoms** (nausea, vomiting, photophobia, phonophobia, other)
7. **Suspected triggers** (food, stress, sleep disruption, hormonal, weather, other)
8. **Acute treatment used** (which herb(s), dose, timing)
9. **Acute treatment response** (time to relief, % pain reduction at 2h)
10. **Attack resolved or still present?**

**Prevention tracking:**
- Which preventive herb(s) taken daily
- Dose and timing
- Any missed doses
- Side effects or observations

**Monthly summary:**
- Total number of migraine attacks
- Total migraine days (some attacks last >1 day)
- Average attack severity (mean pain score)
- Average attack duration (hours)
- Acute medication use (count how many times used)
...
- Prevention: CoQ10 400mg daily, Month 2
```
...
1. **Migraine frequency**: Number of attacks per month
2. **Migraine days**: Total days with migraine (accounts for multi-day attacks)
3. **Average severity**: Mean peak pain score
4. **Average duration**: Mean attack duration in hours
5. **Acute medication use**: Count of times acute treatment used
6. **Disability**: MIDAS score (Migraine Disability Assessment) - validated questionnaire freely available online

**Trigger pattern analysis:**

Create table:
- Sleep disruption → Migraine? (yes/no)
- Stress → Migraine? (yes/no)
- Specific foods → Migraine? (yes/no)
- Hormonal timing (menstruation) → Migraine? (yes/no)
- Weather changes → Migraine? (yes/no)
...
- Baseline (month before starting herbs): 8 attacks
- Month 1 (CoQ10): 7 attacks
- Month 2 (CoQ10): 5 attacks
- Month 3 (CoQ10): 3 attacks
- **Conclusion**: Clear response to CoQ10, achieved 62.5% reduction
...
- Throbbing/pulsating vs steady ache vs sharp/stabbing
- Builds gradually vs sudden onset
- Location (frontal, temporal, occipital, orbital, hemicranial)
...
- Heart rate variability (HRV) - may drop before migraine
...
If using prevention:
- Time of day taken (morning vs evening)
- With meals vs empty stomach
- Any timing correlations with response
...
- Same dose, same timing, every day
- Note any side effects

**Month 6 (Washout):** Stop herb, continue tracking
- Observe if migraine frequency returns to baseline
- This confirms the herb was actually working vs placebo or natural variation

**Months 7-8 (Confirmation):** Resume herb if it worked
- Replication confirms effect was real
- Different response suggests placebo or other factors

**What to look for:**

✅ **Success pattern:**
- Baseline: 8 migraines/month
- On herb months 3-5: 3-4 migraines/month (50% reduction)
- Washout month 6: 7 migraines/month (returns toward baseline)
- Resume months 7-8: 3 migraines/month (benefit confirmed)

❌ **No effect pattern:**
- Random variation throughout all phases
- No clear difference between baseline, treatment, washout, resume
- Example: 5-9 migraines/month randomly in all phases

✅ **Delayed response pattern** (common with prevention):
- Baseline: 8 migraines/month
- Month 3: 7 migraines (minimal change - expected)
- Month 4: 5 migraines (starting to work)
- Month 5: 3 migraines (full effect - 62.5% reduction)
- Confirms timeline hypothesis: prevention takes 2-3 months
...
- Months 1-3: CoQ10 400mg → achieves 30% reduction (helpful but want more)
- Months 4-6: CoQ10 400mg + Nano-curcumin 80mg + Omega-3 2000mg → achieves additional reduction to 60% total (additive/synergistic effect)
- **Conclusion**: Combination superior to monotherapy, confirms multi-mechanism targeting principle
...
For **prevention**:
- **Migraine frequency**: 30-60% reduction
  - Example: 10 attacks/month → 4-7 attacks/month
  - "Responder" typically defined as ≥50% reduction [10,16]
  - CoQ10 NNT=3 means 1 in 3 achieve ≥50% [10]
- **Migraine severity**: 30-50% reduction in peak pain
  - Example: 9/10 pain → 5-6/10 pain
- **Migraine duration**: 30-60% reduction
  - Example: 12-hour attacks → 5-7 hour attacks
- **Disability/quality of life**: MIDAS score improved
- **Acute medication use**: Reduced by 40-60%

For **acute treatment**:
- **Pain reduction at 2h**: ≥50% (standard endpoint)
  - Ginger meta-analysis: Mean difference -1.27 points [9]
  - Peppermint RCT: 52% significant improvement [18]
- **Pain-free at 2h**: 30-50% of attacks
  - Ginger meta-analysis: RR 1.79 (79% increased likelihood) [9]
- **Faster relief**:
  - Peppermint: Immediate-15 min [18]
  - Lavender: 15 min [24]
  - Standard herbs: 2h [9,13]
- **Associated symptom relief**: Nausea, photophobia, phonophobia improved
...
- ≥50% reduction in frequency (or ≥30% if baseline very high)
- Attacks less severe when they occur
- Attacks shorter duration
- Improved ability to function during and between attacks
- Quality of life significantly better
- You feel the treatment is helping (subjective global impression matters)

## Troubleshooting: What If It's Not Working?

### After Adequate Trial with No Improvement

**Question 1: Was the trial actually adequate?**

Common inadequate trials:
- **Dose too low**: Using 200mg CoQ10 when evidence supports 300-400mg [10,16]
- **Timeline too short**: Judging CoQ10 after 6 weeks when it needs 3 months [10]
- **Inconsistent use**: Taking herbs only when "remembering" vs daily
- **Wrong formulation**: Using standard curcumin 200mg when evidence uses 500mg bid [6,21]
...
- **Using pure anti-inflammatory** (ginger) when CGRP pathway is dominant → Try curcumin (CGRP targeting) [6]
- **Using mitochondrial support** (CoQ10) when inflammatory cascade is dominant → Try ginger or curcumin [9,21]
- **Using single-pathway herb** when multi-factorial pattern → Try combinations [12,28,31]
...
- Episodic migraine (vs chronic daily headache)
- Migraine without major comorbidities

Herbs may be insufficient alone for:
- Chronic migraine (≥15 headache days/month)
- Severe disabling migraine unresponsive to multiple pharmaceuticals
...
- Feverfew alone: p=0.26 (non-significant) → Feverfew + Ginger: p=0.002 (highly significant) [13,26]
- Nano-curcumin alone: SMD -0.92 → Nano-curcumin + Omega-3 + CoQ10: SMD 1.19 [12]
- Chuan Xiong + Bai Zhi superior in 10 RCTs vs single herbs [30]

**Switch from monotherapy to combination:**

If CoQ10 alone insufficient after 3 months:
- **Add** nano-curcumin 80mg + omega-3 2000mg (for CGRP + anti-inflammatory synergy) [12]
- **OR switch to** Magnesium 600mg + Riboflavin 400mg + CoQ10 150mg (for complete mitochondrial support) [31]
- **OR try** HERBAMIG multi-herb formula (for multi-layer approach) [28]

If ginger alone insufficient for acute:
- **Add** peppermint topical (different mechanism: TRPM8 vs COX-2/LOX) [18]
- **OR switch to** feverfew + ginger sublingual (proven combination) [13]

### Rule Out Other Headache Disorders

**See neurologist if you have:**

- **New onset headache after age 50** (rule out temporal arteritis, other causes)
- **Sudden severe "thunderclap" headache** (rule out subarachnoid hemorrhage)
- **Headache with fever, stiff neck, confusion** (rule out meningitis)
- **Progressive headache worsening over weeks** (rule out mass lesion, increased intracranial pressure)
- **Headache always on exact same side, never alternates** (rule out secondary causes)
- **"Worst headache of my life" or completely different pattern than usual migraines** (requires evaluation)
...
- Common food triggers (aged cheese, wine, chocolate, processed meats)
- Caffeine withdrawal (maintain consistent intake or taper off completely)
- Sleep disruption (see [[protocols/sleep]] if chronic)
- Stress (consider [[protocols/anxiety]] if prominent)

**Lifestyle modification:**

- **Regular exercise**: Moderate aerobic exercise 3-5x/week shown to reduce migraine frequency
- **Consistent sleep-wake schedule**: Same bedtime and wake time, even weekends
- **Adequate hydration**: Dehydration is common trigger
- **Regular meals**: Avoid fasting/skipping meals (blood sugar fluctuations trigger migraines)

### When to Add Pharmaceutical Options

**Herbs work best for:**
- Mild-to-moderate episodic migraine
- Prevention when willing to wait 2-4 months for effects
- People preferring natural approaches
- Part of integrative plan (herbs + pharmaceuticals can combine)

**Herbs may NOT be sufficient alone for:**
- Severe chronic migraine (≥15 days/month)
- Highly disabling migraine (MIDAS score >20)
- Migraine unresponsive to multiple herbal trials
- Need for rapid prevention effect (e.g., employment threatened by disability)
...
- No meaningful improvement after 6 months optimal herbal treatment
- Migraine worsening despite treatment
- Red flags present (see "Rule Out Other Headache Disorders" above)
- Quality of life severely impacted despite your best efforts
...
- Ginger: GRAS status, extensively studied [9]
- CoQ10: Excellent safety, well-tolerated long-term [10]
- Peppermint/Menthol: Very safe topically [18]
- Lavender: No adverse effects in trials [24,25]
- Chamomile: Generally safe [35]
- Magnesium, Riboflavin, B vitamins: Excellent safety [31]

**Herbs requiring caution:**
- Butterbur: Hepatotoxicity risk - requires PA-free extracts, medical supervision, liver monitoring [11]
- Feverfew: Generally safe but mild GI upset possible
- High-dose curcumin: Rare GI upset at doses >1000mg/day
...
**Butterbur:**
- **Hepatotoxicity** - multiple case reports liver damage [11]
- Only use PA-free (pyrrolizidine alkaloid-free) standardized extracts
- Medical supervision mandatory
- Baseline liver function tests, then monitor monthly × 3, then quarterly
- Avoid alcohol (additive hepatic stress)
- Stop immediately if jaundice, dark urine, abdominal pain, fatigue
- Contraindicated: Any liver disease, pregnancy, breastfeeding

**Ginger:**
- Mild antiplatelet effects - stop 2 weeks before surgery
- May worsen GERD in sensitive individuals
- Generally safe up to 4g/day [9]

**Curcumin:**
- May cause biliary colic if gallstones present
- High doses (>1500mg/day) occasionally cause GI upset
- Fat-soluble - take with meals containing fat for absorption
- Well-tolerated at evidence-based doses (500mg bid standard, 80mg nano-curcumin) [6,12,21]

**Feverfew:**
- May cause mild GI upset, mouth ulcers (rare with standardized extracts)
- Antiplatelet effects - stop before surgery
- "Post-feverfew syndrome" reported rarely after abrupt discontinuation (rebound headache, anxiety, sleep disruption) - taper if used long-term

**White Willow:**
- Contains salicin (aspirin-like) - same precautions as aspirin
- Avoid if aspirin allergy
- Antiplatelet effects
- GI irritation possible (less than aspirin)
- Avoid in pregnancy (theoretical risk like aspirin)

**Lavender:**
- Extremely safe
- No significant adverse effects in trials [24,25]
- Topical use: Rare allergic contact dermatitis (test small area first)

**CoQ10:**
- May reduce effectiveness of warfarin (chemical similarity to vitamin K) - monitor INR
- Otherwise excellent safety profile [10]
- Rare: mild GI upset, insomnia if taken late in day (take with breakfast or lunch)
...
- **Ze 91019** for valerian + hops [22]
- **Petadolex®** for butterbur (PA-free, though still requires caution) [11]
- **HERBAMIG** for multi-herb formula [28]
- **KSM-66** or **Sensoril** for ashwagandha if using for stress component

**Look for standardization:**
- Butterbur: Standardized to petasin content, **PA-free certified**
- Ginger: Standardized to gingerol content (5% minimum)
- Feverfew: Standardized to parthenolide 0.2% minimum
- Curcumin: Standardized to curcuminoid content (95% curcuminoids typical)
- Peppermint: Essential oil standardized to menthol content

**Third-party testing verification:**
- **USP Verified** (United States Pharmacopeia)
- **NSF Certified** (NSF International)
- **ConsumerLab** approved
- Tests for: Heavy metals, pesticides, microbial contamination, actual herb content matches label

**Reputable manufacturers:**
- GMP (Good Manufacturing Practices) certified facilities
- Transparent sourcing documentation
- Companies funding or participating in clinical research
- Batch testing results available

### Drug Interactions

**Anticoagulants/Antiplatelets:**
- Ginger, feverfew, willow have antiplatelet effects
- Monitor INR if on warfarin
- Discuss with prescribing physician before combining

**Migraine pharmaceuticals:**
- Herbs can generally be combined with triptans (sumatriptan, etc.) - no known interactions
- Meta-analysis supports combining herbs with Flunarizine (enhanced effectiveness) [38]
- Discuss with neurologist before combining with CGRP antagonists (newer drugs - limited data on herb interactions)

**Sedatives:**
- If using valerian + hops for sleep component [22,23], may potentiate sedative medications
- Avoid combining without physician approval

**Blood pressure medications:**
- Some TCM formulas may affect blood pressure
- Monitor BP if using Chinese herbal medicine formulas, especially if on antihypertensives
...
- Migraine diary (see N=1 tracking section)
- Disability/quality of life assessment (MIDAS score quarterly)
- Side effects journal
- If using butterbur: Liver function tests (AST, ALT, bilirubin) baseline, monthly × 3, then quarterly [11]

**Seek immediate medical attention if:**
- **Sudden severe "thunderclap" headache** (worst of life, peaks in seconds)
- **Headache with fever, stiff neck, altered consciousness** (meningitis signs)
- **Headache with neurological deficits** (weakness, numbness, speech problems, vision loss beyond typical aura)
- **Headache after head trauma**
- **New onset headache after age 50**
- **Progressive headache worsening over days-weeks**
- **Jaundice, dark urine, severe abdominal pain** (possible liver injury if using butterbur)

**Seek routine medical attention if:**
- Migraine pattern changing significantly
- Worsening despite optimal herbal treatment
- New symptoms developing
- Quality of life severely impacted
- Migraine frequency increasing to ≥15 days/month (chronic migraine threshold)
- Considering pregnancy (reassess herb safety)
...
[2] Steiner TJ, Stovner LJ, Jensen R, Uluduz D, Katsarava Z; Lifting The Burden: the Global Campaign against Headache. Migraine remains second among the world's causes of disability, and first among young women: findings from GBD2019. J Headache Pain. 2020;21(1):137. PMC: 7672978.

[3] Russell FA, King R, Smillie SJ, Kodji X, Brain SD. Calcitonin gene-related peptide: physiology and pathophysiology. Physiol Rev. 2014;94(4):1099-1142. PMC: 4187032.
