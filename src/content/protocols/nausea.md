...
summary: "Evidence-based herbal approaches for pregnancy nausea, chemotherapy-induced nausea, post-operative nausea, and general digestive upset."
symptoms:
...
### For Pregnancy Nausea and Vomiting (NVP)
...
### For IBS and Functional Dyspepsia with Nausea
...
### Aromatherapy-First Strategy (When Oral Route Compromised)
...
### Acute Digestive Upset Protocol
...
1. Aromatherapy works when nothing oral is possible (5-10 min onset)
2. Ginger tea once able to sip small amounts (15-30 min onset, counts toward hydration)
3. Ginger capsules 500-1000mg every 4-6 hours once tolerating fluids (30-60 min onset, sustained 2-4 hours)
...
### Acute Nausea: Hours to Days

**What happens:**
- Aromatherapy: 5-10 minutes to onset [5]
- Tea: 15-30 minutes to onset [6]
- Capsules: 30-60 minutes to onset [6]
- Duration of relief per dose: 1-4 hours [6]

**Conditions this applies to:**
- Food poisoning, gastroenteritis, acute viral illness
- Single-episode nausea from known trigger
- Post-operative nausea (acute phase)
...
### Pregnancy NVP: Days to Weeks

**Timeline breakdown:**

**Days 1-2:** Minimal change (too early)
**Days 3-5:** Mild improvement may appear (50% notice something)
**Week 1:** Moderate improvement (50% report meaningful benefit)
**Weeks 2-4:** Maximum benefit (60-70% responders report substantial improvement) [6,7]
**Non-responders (30-40%):** Try adding vitamin B6, increasing dose to 2g daily, or switching to B6 alone [7]

**Typical improvement by week 4:**
- Nausea severity: 30-50% reduction
- Vomiting frequency: Variable (some studies show benefit, others don't [8])
- Functional improvement: Able to eat more variety, less anxiety about nausea
- Most report quality of life improvement even if nausea not completely eliminated [6]

### CINV: Prophylactic + Acute Phase
...
### IBS/Functional Dyspepsia: Weeks to Months

**Chronic conditions require chronic timelines:**

**Week 1:** Minimal change (too early; gastric motility patterns take time to normalize)
**Week 2:** Mild improvement may appear (early responders)
**Week 4:** Moderate improvement expected (50-70% report significant benefit) [7]
**Week 6:** Approaching maximum benefit
**Weeks 8-12:** Maximum benefit plateau [6,7]
...
2. **Nausea severity** (0-10 scale: 0 = none, 10 = worst imaginable)
3. **Vomiting** (yes/no; if yes, how many episodes)
4. **Triggers** (food, time of day, stress, movement, etc.)
5. **Herb(s) taken** (which one, dose, timing)
6. **Time to relief** (how many minutes until nausea improved after taking herb)
7. **Duration of relief** (how long did improvement last)
8. **Functional impact** (could you eat? work? function normally?)
...
- Average daily nausea severity (mean of all recordings)
- Number of vomiting episodes per week
- Number of "good days" (nausea ≤3) versus "bad days" (nausea ≥7)
- Consistent triggers identified
- Herb effectiveness pattern (which herb/dose/timing works best)

**Pattern identification questions:**
- Is nausea worse at specific times of day? (Morning? Evening? After eating?)
- Do certain foods consistently trigger or relieve nausea?
- Does stress level correlate with nausea severity?
- Which herb formulation (tea vs capsules vs aromatherapy) gives fastest/longest relief?
- Is there a dose-response relationship? (More effective at 1g vs 500mg?)
...
✅ **Success pattern:**
- Consistent severity reduction during "on" weeks (e.g., average 7/10 → 4/10)
- Return toward baseline during washout (if performed)
- Improvement again when resumed
- Functional restoration (able to eat, work, live normally)

❌ **No effect pattern:**
- Random good/bad days throughout all phases
- No difference in average severity between baseline and intervention
- No pattern of relief timing after doses

❌ **Worsening pattern (rare with herbs):**
- Nausea severity increases during treatment
- Improves when stopped
- May indicate wrong formulation (e.g., peppermint oral worsening GERD-related nausea)

### What "Success" Actually Looks Like

**Realistic targets after 2-4 weeks of treatment:**

- **Severity reduction:** 30-50% decrease on 0-10 scale (e.g., 8/10 → 4/10)
- **Frequency reduction:** More good days than bad days (ratio improves)
- **Vomiting reduction:** 50% decrease in episodes per week (variable - not all studies show vomiting benefit [8])
- **Functional restoration:** Able to eat adequate nutrition, maintain work/activities, reduced anxiety about nausea
- **Quality of life:** Rated improvement even if nausea not completely eliminated
...
- Bad days are less frequent AND less severe than before
- Functional capacity is restored (can eat, work, socialize)
- Anxiety about nausea is reduced (psychological impact matters)
- Rescue medication use decreased (for CINV/PONV contexts)
