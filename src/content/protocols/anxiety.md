...
1. **[[materia/lavender|Lavender]] (Silexan)**: Mean difference -3.84 (95% CrI: -6.31 to -1.34) - the leader in number of high-quality trials.[2]

2. **[[materia/ashwagandha|Ashwagandha]]**: Mean difference -4.90 (95% CrI: -9.70 to -0.17) - actually larger effect size than lavender, but fewer trials. Works differently too: HPA axis modulation with 23-33% cortisol reduction documented.[2][6]

3. **[[materia/passionflower|Passionflower]]**: Matched oxazepam (a benzodiazepine) head-to-head in one trial; at least 6 RCTs show benefits comparable to standard anxiolytics.[7][8]

**Tier 2 — Good evidence (established efficacy, some limitations):**

4. **Kava**: Mean difference -2.46 (95% CrI: -4.47 to -0.32) for general anxiety. Here's something interesting though - possibly ineffective for GAD specifically (MD: -0.17). Diagnostic specificity matters with this one. **Critical safety issue: hepatotoxicity risk means you need medical supervision.**[2][9]

5. **Saffron**: At least 6 RCTs showing benefits comparable to standard anxiolytics and antidepressants. Typical dose 30 mg daily.[8]

**Tier 3 — Emerging evidence (encouraging results, needs larger studies):**

6. **[[materia/chamomile|Chamomile]]**: 2024 systematic review reports "encouraging early results" with multi-system action affecting GABA, serotonin, and HPA axis; needs larger-scale studies.[10][11]

7. **[[materia/ginkgo|Ginkgo biloba]]**: Mean difference -4.63 (95% CrI: -9.01 to -0.23); only herb showing statistical difference versus another herb (kava) in network meta-analysis, but limited by small sample sizes.[2]

**Tier 4 — Traditional formulas (strong clinical use, growing evidence):**

8. **Chinese Medicine Formulas**: A 2025 meta-analysis of 92 trials found Chinese herbal medicine more effective than anxiolytic medication (HAMA improvement: -1.50 points, 95% CI -2.21 to -0.78, p < 0.001).[12] Jieyu Anshen combined with paroxetine showed 30% better effectiveness than medication alone in 95 RCTs (8,188 participants).[13]

9. **L-Lysine + L-Arginine**: "Strong evidence" designation from systematic review; clinical trial showed normalized stress responses and reduced cortisol within one week.[14][15]

### Critical Finding: Equivalence Across Top Herbs
...
### Primary Approach: Lavender Oil (Silexan)
...
### For Stress-Related Anxiety: Ashwagandha
...
### Benzodiazepine Alternative: Passionflower
...
### For Non-Sedating Anxiolytic: Kava
...
### For Anxiety with Depression: Saffron
...
### Traditional Combination: Three Sisters for Sleep-Related Anxiety
...
**Studied doses:**
- Valerian: 300 mg extract (standardized to 0.8% total valerenic acid)
- Passionflower: 80 mg extract (standardized to 4% isovitexin)
- Hops: 30 mg extract (standardized to 0.35% rutin)[26]
...
### L-Lysine + L-Arginine: Evidence-Based Synergistic Combination
...
- Lavender aromatherapy: Minutes
- L-lysine + L-arginine: Within hours for acute stress; 1 week for sustained effects[15]
- Kava: Days to 1-2 weeks[9]

**Standard response (2-4 weeks):**
- Silexan (lavender oil): 2-4 weeks[2]
- Chamomile: 2-4 weeks[10]
- Passionflower: Days to 4 weeks (matches benzodiazepine by week 4)[7]

**Extended response (4-13 weeks):**
- Ashwagandha: 4-13 weeks for full HPA axis effects; cortisol changes peak at 8-13 weeks[6]
- St. John's Wort: 4-6 weeks for mood effects[29]

**Constitutional balancing (months):**
- Traditional Chinese Medicine formulas (Jiu Wei Zhen Xin, Xiao Yao San, Jieyu Anshen): 3-6 months for deep systemic balancing[12][13]
- Ayurvedic formulas (Saraswatarishta, Ashwagandharishta): 3-6 months for nervous tissue rejuvenation

**Comparison to pharmaceuticals:**
- Benzodiazepines: Immediate (but tolerance and dependence risks)
- SSRIs: 4-6 weeks for initial effect, 8-12 weeks for full effect
- Herbs: Comparable timelines to SSRIs for moderate-onset options; faster options (kava, passionflower) approach benzodiazepine onset without addiction risk
...
1. **GAD-7 (Generalized Anxiety Disorder 7-item scale):**
   - Self-administered, takes 2-3 minutes
...
2. **Hamilton Anxiety Rating Scale (HAMA):**
   - Clinician-administered (14 items)
   - Gold standard used in most research studies
   - Track at baseline, 4 weeks, 8 weeks, 12 weeks
...
- Salivary or serum cortisol: Baseline and week 8-12
- Morning cortisol particularly informative (highest in AM for most people)
- Consider 4-point salivary cortisol curve (waking, mid-morning, afternoon, evening) for comprehensive HPA assessment

**Response criteria:**

- **Full response:** >50% reduction in anxiety symptoms; GAD-7 score decrease ≥5 points
- **Partial response:** 25-50% reduction; GAD-7 decrease 3-4 points
- **Inadequate response:** <25% reduction; GAD-7 decrease <3 points

**If inadequate response after adequate trial (therapeutic dose for expected timeline):**

1. Verify product quality - standardized extract from reputable manufacturer?
2. Assess adherence - taking consistently at correct dose?
3. Try different herb with different primary mechanism (switch from GABA → serotonin → HPA axis)
4. Add evidence-based synergistic combination (L-lysine + L-arginine)
5. Reassess diagnosis - GAD vs other anxiety disorder? Comorbid depression? Medical causes (thyroid, caffeine excess)?
6. Consider conventional treatment - may require pharmaceutical intervention; herbs can remain as adjunct with medical supervision
