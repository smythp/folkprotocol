...
summary: "Evidence-based herbal approaches for attention, working memory, mental fatigue, and ADHD symptoms."
symptoms:
...
- For attention: Polygonum odoratum + Morus alba (1500 mg) ranked highest with SUCRA 83.4 [2]
- For memory/executive function: Cistanche tubulosa + [[materia/ginkgo]] was best [2]

Traditional combinations also show promise:
- Ayurvedic Rasayanas: Brahmi + Ashwagandha + Shankhpushpi + [[materia/gotu-kola]] [17]
- TCM Gui Pi Tang: Includes Polygala (now validated as network meta winner) for mental fatigue from overthinking [10]
...
### For ADHD Symptoms (Restlessness, Impulsivity, Distractibility)
...
### For Mental Fatigue / Energy Depletion
...
### For Brain Fog / Poor Mental Clarity
...
### For Attention Deficits (Acute Need, <2 Hours)
...
### For Chronic Attention Deficits
...
### Traditional Chinese Medicine Pattern-Based
...
### Combination Strategies by Mechanism
...
Options:
- [[materia/bacopa]] 300-600 mg (AChE inhibition + synthesis activation) [9]
- [[materia/rosemary]] 500-750 mg (most potent AChE inhibitor tested) [15]
- [[materia/ashwagandha]] 225-400 mg (AChE inhibition) [7]
...
Options:
- [[materia/rhodiola]] 170-576 mg (MAO-B inhibition → dopamine) [13]
- Polygala 300 mg/day (reuptake inhibition: serotonin, dopamine, norepinephrine) [12]
...
Options:
- [[materia/lions-mane]] (NGF synthesis, neuronal regeneration)
- [[materia/ginkgo]] 240 mg (cerebral blood flow, antioxidant) [19]
- [[materia/rosemary]] 750 mg (Nrf2 pathway, synapse formation) [15]

Stack: [[materia/lions-mane]] + [[materia/ginkgo]] 240 mg [22]

## Focus Herb Comparison
...
**What to expect:**
- L-theanine + Caffeine works immediately (30-60 minutes) [3]
- American ginseng may show acute effects (calmness, reaction time) [14]
- Rhodiola 170 mg may improve mental performance within days [13]
- Most other herbs: minimal effects yet as receptor changes haven't occurred

**Who responds early:**
- Acute interventions (L-theanine + caffeine) [3]
- Mild symptoms with low-dose rhodiola or ginseng [13,14]
- Highly responsive individuals

**Who doesn't respond yet:**
- Bacopa users (needs 8 weeks minimum) [9]
- Chronic, severe cases requiring receptor remodeling
- Combination protocols requiring multiple pathways to engage

### Week 3-4: Early Effects Emerging

**What research shows:**
- Ashwagandha: Cortisol reduction and stress response improvement by 30 days [7]
- Rhodiola 576mg: Concentration improvement becomes pronounced [13]
- Rosemary: Memory enhancement, anxiety reduction evident at 1 month [15]

**Expected improvements:**
- Mental fatigue reduced by 10-20%
- Slightly better task persistence
- Improved subjective sense of "mental clarity"
- Stress-related brain fog beginning to lift (if using ashwagandha)

**This is too early to judge bacopa, polygala, or long-acting combinations.** Don't give up.

### Week 8-12: Standard Assessment Point for Chronic Herbs

**What research shows:**
- Bacopa: Effects "typically emerge at 8-12 weeks" [9]
- Bacopa + Ashwagandha: Full benefits by 12 weeks for ADHD [6,7,8]
- [[materia/ginkgo]] + Bacopa combinations: Require 12+ weeks (4-week trial failed) [20]

**Expected improvements:**
- Working memory noticeably better (fewer "what was I doing?" moments)
- ADHD symptoms: 30-50% reduction in restlessness, improved self-control [8]
- Mental fatigue: 30% reduction (rhodiola) [13]
- Attention span: measurably longer task engagement
- Brain fog: significantly cleared

**Cognitive domain specifics:**
- Memory/recall: Bacopa effect size 0.95 (substantial benefit) [1]
- Mental fatigue: Rhodiola 30% reduction [13]
- ADHD: Bacopa 93% restlessness reduction, Ashwagandha p<0.001 improvement [7,8]
...
**Strategy:**
- Polyherbal formulas (Bacopa + Sea buckthorn + Dioscorea showed benefits at 12 months) [18]
- Traditional rasayanas for long-term brain rejuvenation [17]
- Neuroprotective combinations ([[materia/lions-mane]] + [[materia/ginkgo]]) [22]
- Rotate herbs every 2-3 months to prevent tolerance

## N=1 Tracking: Building Your Personal Data
...
- Morning mental clarity (1-10 scale)
- Ability to sustain attention on single task (minutes before distraction)
- Mental fatigue by afternoon (1-10 scale, 10 = exhausted)
- Number of "brain fog" moments (forgot what you were doing, lost train of thought)
...
**Objective measures:**
- Digit span test (working memory - free online tests)
- Stroop test (attention and cognitive flexibility)
- Dual N-back (working memory training app that tracks performance)
- Typing speed and accuracy during focused work

**Pattern identification:**
- Which days are best/worst cognitively?
- Correlation with sleep quality, stress, diet, exercise?
- Do certain herbs consistently improve specific metrics?

### Simple A/B Testing Protocol

**Weeks 1-2 (Baseline):** Track daily without intervention
**Weeks 3-10 (Intervention):** Take selected herb consistently, continue tracking
**Week 11 (Washout):** Stop herb for 1 week, maintain tracking
**Weeks 12-13 (Confirmation):** Resume herb if beneficial

**What to look for:**
- Consistent improvement during intervention weeks (especially weeks 8-10 for bacopa)
- Decline during washout week
- Return of benefits when restarted

**Red flags:**
- Random good/bad days with no pattern (likely not the herb)
- No difference between baseline, intervention, and washout (herb isn't working)
- Worsening during intervention (wrong herb, wrong dose, or adverse reaction)

### What "Success" Looks Like

**Realistic targets after 8-12 weeks:**
- 30-50% reduction in ADHD symptoms (restlessness, impulsivity) [8]
- 30% reduction in mental fatigue [13]
- Working memory: fewer lapses, better task switching
- Attention span: 50-100% increase in sustained focus duration
- Brain fog: "clear" days 5-7x per week vs 1-2x at baseline

**Note:** You won't achieve perfect focus every day. The goal is consistent, measurable improvement in cognitive function.

## What If Nothing Works After 12 Weeks?

### Reassess Your Approach

**Wrong herb for your symptom?**
- Using bacopa for acute attention (it's for chronic enhancement over 8-12 weeks) [9]
- Using attention herbs for fatigue (need rhodiola instead) [13]
- Using cognitive enhancers for stress-fog (need adaptogens first) [6,7]

**Dose too low?**
- Bacopa: Are you taking at least 300 mg? Studies show 300-600 mg range [9]
- Rhodiola: Severe fatigue may need 576 mg, not 170 mg [13]
- Ashwagandha: Benefits at 225-400 mg; lower doses may be insufficient [7]

**Timeline too short?**
- Bacopa needs 8-12 weeks minimum [9]
- [[materia/ginkgo]] + Bacopa combination: 4 weeks failed, need 12+ weeks [20]
- Traditional formulas: May need 3+ months [10,11]

### Consider Combination vs Single Herb

**Evidence suggests combinations work better:**
- Network meta-analysis: Top performers were combinations [2]
- Bacopa + Ashwagandha for ADHD [6,7,8]
- L-theanine + Caffeine showed synergy "beyond individual components" [3]

**Try switching from:**
- Bacopa alone → Bacopa + Ashwagandha [6]
- Single adaptogen → Rhodiola + Polygala
- Western herbs → TCM pattern-based formula [10,11]

### Rule Out Underlying Issues

**See a healthcare provider if you have:**
- Severe ADHD unresponsive to 12 weeks of herbs → may need prescription medication
- Brain fog with other symptoms (joint pain, weight changes, temperature sensitivity) → check thyroid function
- Mental fatigue with physical exhaustion, sleep issues → sleep study to rule out apnea
- Focus problems with depression or severe anxiety → may need integrated mental health treatment

**Add non-herbal adjuncts:**
- Sleep optimization (poor sleep devastates cognition)
- Stress management (chronic stress impairs prefrontal function)
- Exercise (increases BDNF, improves cerebral blood flow)
- Omega-3s (EPA/DHA support neuronal membrane function)

### When to Try Prescription Options

Herbs work best for:
- Mild-to-moderate focus problems
- Stress-related cognitive impairment
- Age-related cognitive decline (prevention and early stages)
- ADHD as adjunct to behavioral interventions

Herbs may NOT be enough for:
- Severe ADHD causing major life impairment
- Focus problems from untreated medical conditions (hypothyroidism, sleep apnea, etc.)
- Cognitive impairment from major depression or anxiety disorders
...
- "Herbal nootropics generally well-tolerated" [23]
- Bacopa: "Only 2.3% reported mild side effects" [9]
- ADHD herbs: "Favorable safety profile" in pediatric populations [8]

Most focus herbs are safe for 3-6 months of continuous use. Long-term safety data (>1 year) is limited.

### Common Side Effects (Generally Mild)

**Gastrointestinal upset:** Occasional with bacopa, ashwagandha (take with food)
**Headache:** Rare with most herbs
**Overstimulation:** Possible with rhodiola, ginseng (take earlier in day)
**Jitteriness:** L-theanine + caffeine (if caffeine-sensitive, reduce dose)
...
**Ashwagandha:**
- Taper over 1-2 weeks if used >3 months (allows HPA axis to re-adapt) [7]
- Monitor thyroid function if pre-existing thyroid condition
- Monitor blood sugar if diabetic

**Rosemary:**
- Do NOT exceed 1,500 mg daily (6,000 mg showed cognitive impairment) [15]
- Elderly: 750 mg optimal, not higher [15]

**Rhodiola:**
- Take morning/early afternoon (may interfere with sleep)
- Evidence quality variable; individual response varies [13]

**[[materia/ginkgo]]:**
- Maximum 240 mg daily for drug interaction safety [19]
- Avoid if on anticoagulants without medical supervision

### Quality & Standardization Matters

**Clinical impact:**
- Bacopa standardization: 50% bacosides critical [9]
- [[materia/ginkgo]] standardization: 24% flavonoid glycosides, 6% terpene lactones (EGb 761) [19]
- Extraction method affects potency dramatically

**Recommendation:**
- Use standardized extracts when available
- Buy from manufacturers with third-party testing (USP, NSF, ConsumerLab)
- For well-studied formulations (Ze 91019, Relora®), brand matters

### Drug Interactions

**Anticoagulants/antiplatelets:** [[materia/ginkgo]] may enhance effects [19]
**Thyroid medications:** Ashwagandha may affect levels [7]
**Diabetes medications:** Ashwagandha may enhance glucose-lowering [7]
**Sedatives:** Ashwagandha may potentiate effects [7]
**Stimulants:** L-theanine + caffeine - be aware of total caffeine intake [3]
